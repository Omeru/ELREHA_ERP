...
public class ProductSales extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    String strNameValue ;
    if (vars.commandIn("DEFAULT1")) {
      removePageSessionVariables(vars);
      strNameValue = vars.getRequestGlobalVariable("inpNameValue", "ProductSales.name");
      ...
      if (!strIDValue.equals("")) {
        String strNameAux = ProductData.existsActualValue(this, vars.getLanguage(), strNameValue,
            strIDValue);
        if (!strNameAux.equals(""))
          strNameValue = strNameAux;
      }
      String windowId = vars.getRequestGlobalVariable("WindowID", "ProductSales.windowId");
      String strWarehouse = vars.getRequestGlobalVariable("inpWarehouse",
          "ProductSales.warehouse");
      if (strWarehouse.equals(""))
        strWarehouse = Utility.getContext(this, vars, "M_Warehouse_ID", windowId);
      vars.setSessionValue("ProductSales.warehouse", strWarehouse);
      String strBpartner = vars.getRequestGlobalVariable("inpBPartner", "ProductSales.bpartner");
      vars.removeSessionValue("ProductSales.key");
      // if (!strNameValue.equals(""))
      // strNameValue = strNameValue + "%";
      vars.setSessionValue("ProductSales.name", strNameValue);
      ...
      vars.setSessionValue("ProductSales.isSOTrx", isSOTrx);
      String strStore = vars.getStringParameter("inpWithStoreLines");
      //vars.setSessionValue("ProductSales.withstorelines", strStore);

      printPage(response, vars, "", strNameValue, strWarehouse, strStore, strBpartner, "", "",
          "paramName");
    } else if (vars.commandIn("KEY") || vars.commandIn("DEFAULT")) {
      removePageSessionVariables(vars);
      String windowId = vars.getRequestGlobalVariable("WindowID", "ProductSales.windowId");
      String strKeyValue = vars.getRequestGlobalVariable("inpNameValue", "ProductSales.key");
      String strIDValue = vars.getStringParameter("inpIDValue");
      if (!strIDValue.equals("")) {
      ...
      vars.removeSessionValue("ProductSales.name");
   ...
   // Test , if there is something with this name
      if (ProductData.getValueCount(this, strKeyValue).equals("0") && 
        ...
        vars.setSessionValue("ProductSales.name", strKeyValue);
        vars.removeSessionValue("ProductSales.key");
        strNameValue=strKeyValue;
        strKeyValue="%";
      } else {
        vars.setSessionValue("ProductSales.key", strKeyValue);
        vars.removeSessionValue("ProductSales.name");
        strNameValue="%";
      }
    // vars.setSessionValue("ProductSales.withstorelines", strStore);

      ProductSalesData[] data = null;
      String strClients = Utility.getContext(this, vars, "#User_Client", "ProductSales");
      ...
      if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
        ...
        pgLimit = "2";
          ...
          data = ProductSalesData.selectNotStoredtrl(this, rownum, vars.getLanguage(),
      ...
      String strKey = vars.getGlobalVariable("inpKey", "ProductSales.key", "");
      String strName = vars.getGlobalVariable("inpName", "ProductSales.name", "");
      String strWarehouse = vars.getGlobalVariable("inpWarehouse", "ProductSales.warehouse", "");
 //     String strBpartner = vars.getGlobalVariable("inpBPartner", "ProductSales.bpartner", "");
      String strStore = vars.getGlobalVariable("inpWithStoreLines",
          "ProductSales.withstorelines", "");
      ...
      String strCategory = "E4A58F68B2724B74A6563585A2E8FB4C"; //vars.getGlobalVariable("inpProductCategory", "Product.ProductCategory", "");
      String strType = ""; //vars.getGlobalVariable("inpTypeOfProduct", "Product.TypeOfProduct", "");

      String windowId = vars.getGlobalVariable("WindowID", "ProductSales.windowId", "");
      String isCalledFromProduction = "";
      if (windowId.equals("800051") || (windowId.equals("800052"))) {
        log4j
            .debug("selector called from process plan||work requirement using production=y filter");
  ...
  private void removePageSessionVariables(VariablesSecureApp vars) {
    vars.removeSessionValue("ProductSales.key");
    vars.removeSessionValue("ProductSales.name");
    vars.removeSessionValue("ProductSales.warehouse");
    vars.removeSessionValue("ProductSales.bpartner");
    vars.removeSessionValue("ProductSales.withstorelines");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/elreha/sales/info/ProductSales").createXmlDocument();
//        "org/openbravo/erpCommon/info/ProductComplete").createXmlDocument();
  ...
  private void printPageKey(HttpServletResponse response, VariablesSecureApp vars,
      ProductSalesData[] data, String strWarehouse) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
  ...
  private String generateResult(ProductSalesData[] data, String strWarehouse, DecimalFormat df)
      ...
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) {
          ...
          if (strStore.equals("Y")) {
            ...
            strNumRows = ProductSalesData.countRows(this, rownum, strKey, strName, strWarehouse,
            ...
            // single countRows method is used
            strNumRows = ProductSalesData.countRowsNotStored(this, rownum, strKey, strName,strBpartner, strCategory,strVendorProduct,strType, strClients, strOrgs, strIsCalledFromProduction, pgLimit, oraLimit1,
                oraLimit2);
          }

          vars.setSessionValue("ProductSales.numrows", strNumRows);
        } else {
          strNumRows = vars.getSessionValue("ProductSales.numrows");
        }
          ...
          if (strStore.equals("Y")) {
              ...
              data = ProductSalesData.selecttrl(this, vars.getLanguage(),strWarehouse, "1", strKey, strName,
              ...
              data = ProductSalesData.selectNotStoredtrl(this, "1", vars.getLanguage(), strKey, strName, strBpartner, strCategory,strVendorProduct,strType,strClients, strOrgs, strIsCalledFromProduction, strOrderBy, pgLimit,"","");
          }
