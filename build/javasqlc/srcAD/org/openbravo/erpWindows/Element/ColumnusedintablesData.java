 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Column" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , AD_Callout_ID = (?) , ColumnName = (?) , AD_Table_ID = (?) , Description = (?) , IsActive = (?) , DefaultValue = (?) , AD_Reference_ID = (?) , IsTranslated = (?) , IsIdentifier = (?) , ReadOnlyLogic = (?) , IsKey = (?) , AD_Reference_Value_ID = (?) , AD_Column_ID = (?) , FieldLength = TO_NUMBER(?) , AD_Element_ID = (?) , AD_Process_ID = (?) , AD_Val_Rule_ID = (?) , Help = (?) , IsParent = (?) , updated = now(), updatedby = ? " +
      "        WHERE AD_Column.AD_Column_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, AD_Callout_ID, ColumnName, AD_Table_ID, Description, IsActive, DefaultValue, AD_Reference_ID, IsTranslated, IsIdentifier, ReadOnlyLogic, IsKey, AD_Reference_Value_ID, AD_Column_ID, FieldLength, AD_Element_ID, AD_Process_ID, AD_Val_Rule_ID, Help, IsParent, created, createdby, updated, updatedBy)" +
