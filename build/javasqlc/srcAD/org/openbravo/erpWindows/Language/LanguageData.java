  ...
  public static LanguageData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLanguageData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        ...
        objectLanguageData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
...
Create a registry
 */
  public static LanguageData[] set(String adLanguage, String name, String translatedby, String adOrgId, String adLanguageId, String isrtl, String updatedby, String updatedbyr, String pixelsize, String countrycode, String processing, String createdby, String createdbyr, String isbaselanguage, String issystemlanguage, String isactive, String languageiso, String adClientId)    throws ServletException {
...
Select for auxiliar field
 */
  public static String selectDef616_0(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef614_1(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Language" +
      "        SET AD_Language_ID = (?) , AD_Client_ID = (?) , Pixelsize = TO_NUMBER(?) , AD_Org_ID = (?) , AD_Language = (?) , Name = (?) , LanguageISO = (?) , CountryCode = (?) , IsActive = (?) , IsSystemLanguage = (?) , Isrtl = (?) , Translatedby = (?) , Processing = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Language_ID, AD_Client_ID, Pixelsize, AD_Org_ID, AD_Language, Name, LanguageISO, CountryCode, IsActive, IsSystemLanguage, Isrtl, Translatedby, Processing, created, createdby, updated, updatedBy)" +
