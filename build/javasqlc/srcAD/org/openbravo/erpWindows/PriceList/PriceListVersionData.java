...
Create a registry
 */
  public static PriceListVersionData[] set(String mPricelistId, String description, String isactive, String adOrgId, String mPricelistVersionBaseId, String name, String proccreate, String mPricelistVersionGenerate, String createdby, String createdbyr, String mPricelistVersionId, String validfrom, String updatedby, String updatedbyr, String mDiscountschemaId, String adClientId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , M_PriceList_ID = (?) , Name = (?) , Description = (?) , ValidFrom = TO_DATE(?) , IsActive = (?) , M_Pricelist_Version_Base_ID = (?) , M_DiscountSchema_ID = (?) , M_Pricelist_Version_Generate = (?) , M_PriceList_Version_ID = (?) , ProcCreate = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_PriceList_Version.M_PriceList_Version_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, M_PriceList_ID, Name, Description, ValidFrom, IsActive, M_Pricelist_Version_Base_ID, M_DiscountSchema_ID, M_Pricelist_Version_Generate, M_PriceList_Version_ID, ProcCreate, created, createdby, updated, updatedBy)" +
