  ...
  public static PriceData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectPriceData.cUomId = UtilSql.getValue(result, "c_uom_id");
        objectPriceData.cUomIdr = UtilSql.getValue(result, "c_uom_idr");
...
Create a registry
 */
  public static PriceData[] set(String mProductId, String mProductIdr, String pricelist, String cUomId, String pricestd, String isactive, String adClientId, String pricelimit, String adOrgId, String createdby, String createdbyr, String mPricelistVersionId, String mProductpriceId, String updatedby, String updatedbyr)    throws ServletException {
    ...
    objectPriceData[0].cUomId = cUomId;
    objectPriceData[0].cUomIdr = "";
