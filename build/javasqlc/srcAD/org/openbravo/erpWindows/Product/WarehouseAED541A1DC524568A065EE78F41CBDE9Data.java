...
Create a registry
 */
  public static WarehouseAED541A1DC524568A065EE78F41CBDE9Data[] set(String mProductId, String mLocatorId, String mLocatorIdr, String mProductIdr, String qtyonhand, String cUomId, String qtyincomming, String createdby, String createdbyr, String qtyreserved, String updatedby, String updatedbyr, String qtyinflow, String qtyordered, String qtyinsale, String adClientId, String zssiOnhanqtyId, String mWarehouseId, String qtyoutflow, String isactive, String adOrgId, String mAttributesetinstanceId, String mAttributesetinstanceIdr)    throws ServletException {
