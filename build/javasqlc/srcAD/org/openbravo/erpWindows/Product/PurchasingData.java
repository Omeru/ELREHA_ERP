...
Create a registry
 */
  public static PurchasingData[] set(String mProductId, String createdby, String createdbyr, String cBpartnerId, String cBpartnerIdr, String cUomId, String discontinuedby, String costperorder, String orderMin, String iscurrentvendor, String mProductPoId, String mProductIdr, String priceeffective, String vendorcategory, String pricelastinv, String pricelist, String deliverytimeActual, String isactive, String pricepo, String updatedby, String updatedbyr, String discontinued, String adClientId, String orderPack, String mManufacturerId, String pricelastpo, String ismultipleofminimumqty, String vendorproductno, String cCurrencyId, String qtystd, String upc, String qualityrating, String royaltyamt, String capacity, String adOrgId, String deliverytimePromised, String manufacturernumber)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_Product_PO" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , M_Product_ID = (?) , C_BPartner_ID = (?) , QualityRating = TO_NUMBER(?) , IsActive = (?) , IsCurrentVendor = (?) , UPC = (?) , C_Currency_ID = (?) , C_UOM_ID = (?) , PriceList = TO_NUMBER(?) , PricePO = TO_NUMBER(?) , PriceLastPO = TO_NUMBER(?) , PriceLastInv = TO_NUMBER(?) , DeliveryTime_Promised = TO_NUMBER(?) , VendorProductNo = (?) , VendorCategory = (?) , M_Manufacturer_ID = (?) , manufacturernumber = (?) , Discontinued = (?) , DiscontinuedBy = TO_DATE(?) , Qtystd = TO_NUMBER(?) , Order_Min = TO_NUMBER(?) , ismultipleofminimumqty = (?) , RoyaltyAmt = TO_NUMBER(?) , PriceEffective = TO_DATE(?) , Capacity = TO_NUMBER(?) , Order_Pack = TO_NUMBER(?) , DeliveryTime_Actual = TO_NUMBER(?) , M_Product_PO_ID = (?) , CostPerOrder = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE M_Product_PO.M_Product_PO_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, M_Product_ID, C_BPartner_ID, QualityRating, IsActive, IsCurrentVendor, UPC, C_Currency_ID, C_UOM_ID, PriceList, PricePO, PriceLastPO, PriceLastInv, DeliveryTime_Promised, VendorProductNo, VendorCategory, M_Manufacturer_ID, manufacturernumber, Discontinued, DiscontinuedBy, Qtystd, Order_Min, ismultipleofminimumqty, RoyaltyAmt, PriceEffective, Capacity, Order_Pack, DeliveryTime_Actual, M_Product_PO_ID, CostPerOrder, created, createdby, updated, updatedBy)" +
