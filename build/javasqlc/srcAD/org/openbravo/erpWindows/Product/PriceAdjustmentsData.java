...
Create a registry
 */
  public static PriceAdjustmentsData[] set(String mProductPoId, String issalesoffer, String pricelistSelection, String mManufacturerId, String mOfferId, String productSelection, String createdby, String createdbyr, String addamt, String name, String description, String adOrgId, String mProductId, String mProductIdr, String priority, String bpartnerSelection, String datefrom, String discount, String cBpartnerId, String cBpartnerIdr, String cUomId, String mOfferVId, String bpGroupSelection, String isactive, String fixed, String updatedby, String updatedbyr, String adClientId, String dateto, String directpurchasecalc, String qtyFrom, String qtyTo, String prodCatSelection)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_Offer_V" +
      "        SET M_Product_ID = (?) , C_Bpartner_ID = (?) , Name = (?) , Isactive = (?) , Directpurchasecalc = (?) , C_Uom_ID = (?) , M_Manufacturer_ID = (?) , Datefrom = TO_DATE(?) , Dateto = TO_DATE(?) , QTY_From = TO_NUMBER(?) , QTY_To = TO_NUMBER(?) , Priority = TO_NUMBER(?) , Discount = TO_NUMBER(?) , Addamt = TO_NUMBER(?) , Fixed = TO_NUMBER(?) , Bpartner_Selection = (?) , Product_Selection = (?) , Pricelist_Selection = (?) , AD_Client_ID = (?) , Prod_Cat_Selection = (?) , M_Offer_V_ID = (?) , M_Product_Po_ID = (?) , M_Offer_ID = (?) , BP_Group_Selection = (?) , Description = (?) , AD_Org_ID = (?) , Issalesoffer = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_Offer_V.M_Offer_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, C_Bpartner_ID, Name, Isactive, Directpurchasecalc, C_Uom_ID, M_Manufacturer_ID, Datefrom, Dateto, QTY_From, QTY_To, Priority, Discount, Addamt, Fixed, Bpartner_Selection, Product_Selection, Pricelist_Selection, AD_Client_ID, Prod_Cat_Selection, M_Offer_V_ID, M_Product_Po_ID, M_Offer_ID, BP_Group_Selection, Description, AD_Org_ID, Issalesoffer, created, createdby, updated, updatedBy)" +
