...
Create a registry
 */
  public static PriceAdjustmentData[] set(String mProductpriceId, String addamt, String qtyTo, String directpurchasecalc, String mOfferplistVId, String isactive, String priority, String description, String qtyFrom, String dateto, String mPricelistId, String prodCatSelection, String issalesoffer, String productSelection, String name, String pricelistSelection, String discount, String mProductId, String mProductIdr, String bpartnerSelection, String adOrgId, String updatedby, String updatedbyr, String createdby, String createdbyr, String bpGroupSelection, String datefrom, String cUomId, String fixed, String adClientId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Product_ID = (?) , Name = (?) , Isactive = (?) , Directpurchasecalc = (?) , C_Uom_ID = (?) , Datefrom = TO_DATE(?) , Dateto = TO_DATE(?) , QTY_From = TO_NUMBER(?) , QTY_To = TO_NUMBER(?) , Priority = TO_NUMBER(?) , Discount = TO_NUMBER(?) , Addamt = TO_NUMBER(?) , Fixed = TO_NUMBER(?) , AD_Org_ID = (?) , M_Offerplist_V_ID = (?) , M_Pricelist_ID = (?) , BP_Group_Selection = (?) , Issalesoffer = (?) , Prod_Cat_Selection = (?) , Product_Selection = (?) , Description = (?) , Pricelist_Selection = (?) , Bpartner_Selection = (?) , AD_Client_ID = (?) , M_Productprice_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE m_offerplist_v.M_Offerplist_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, Name, Isactive, Directpurchasecalc, C_Uom_ID, Datefrom, Dateto, QTY_From, QTY_To, Priority, Discount, Addamt, Fixed, AD_Org_ID, M_Offerplist_V_ID, M_Pricelist_ID, BP_Group_Selection, Issalesoffer, Prod_Cat_Selection, Product_Selection, Description, Pricelist_Selection, Bpartner_Selection, AD_Client_ID, M_Productprice_ID, created, createdby, updated, updatedBy)" +
