...
WAD Generated class
 */
class UOMData implements FieldProvider {
static Logger log4j = Logger.getLogger(UOMData.class);
...
Select for edit
 */
  public static UOMData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static UOMData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((mProductId==null || mProductId.equals(""))?"":"  AND M_Product_UOM.M_Product_ID = ?  ");
    strSql = strSql + 
      "        AND M_Product_UOM.M_Product_Uom_Id = ? " +
      "        AND M_Product_UOM.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND M_Product_UOM.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        UOMData objectUOMData = new UOMData();
        objectUOMData.created = UtilSql.getValue(result, "created");
        objectUOMData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectUOMData.updated = UtilSql.getValue(result, "updated");
        objectUOMData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectUOMData.updatedby = UtilSql.getValue(result, "updatedby");
        objectUOMData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectUOMData.mProductUomId = UtilSql.getValue(result, "m_product_uom_id");
        objectUOMData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectUOMData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        objectUOMData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectUOMData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
        objectUOMData.mProductId = UtilSql.getValue(result, "m_product_id");
        objectUOMData.mProductIdr = UtilSql.getValue(result, "m_product_idr");
        objectUOMData.cUomId = UtilSql.getValue(result, "c_uom_id");
        objectUOMData.cUomIdr = UtilSql.getValue(result, "c_uom_idr");
        objectUOMData.isactive = UtilSql.getValue(result, "isactive");
        objectUOMData.language = UtilSql.getValue(result, "language");
        objectUOMData.adUserClient = "";
        objectUOMData.adOrgClient = "";
        objectUOMData.createdby = "";
        objectUOMData.trBgcolor = "";
        objectUOMData.totalCount = "";
        objectUOMData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectUOMData);
    ...
    UOMData objectUOMData[] = new UOMData[vector.size()];
    vector.copyInto(objectUOMData);
    return(objectUOMData);
  }

/**
Create a registry
 */
  public static UOMData[] set(String mProductId, String updatedby, String updatedbyr, String mProductUomId, String cUomId, String adOrgId, String createdby, String createdbyr, String isactive, String adClientId, String mProductIdr)    throws ServletException {
    UOMData objectUOMData[] = new UOMData[1];
    objectUOMData[0] = new UOMData();
    objectUOMData[0].created = "";
    objectUOMData[0].createdbyr = createdbyr;
    objectUOMData[0].updated = "";
    objectUOMData[0].updatedTimeStamp = "";
    objectUOMData[0].updatedby = updatedby;
    objectUOMData[0].updatedbyr = updatedbyr;
    objectUOMData[0].mProductUomId = mProductUomId;
    objectUOMData[0].adClientId = adClientId;
    objectUOMData[0].adClientIdr = "";
    objectUOMData[0].adOrgId = adOrgId;
    objectUOMData[0].adOrgIdr = "";
    objectUOMData[0].mProductId = mProductId;
    objectUOMData[0].mProductIdr = mProductIdr;
    objectUOMData[0].cUomId = cUomId;
    objectUOMData[0].cUomIdr = "";
    objectUOMData[0].isactive = isactive;
    objectUOMData[0].language = "";
    return objectUOMData;
  }
 ...
 */
  public static String selectDef800011_0(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef800008_1(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef800009_2(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
