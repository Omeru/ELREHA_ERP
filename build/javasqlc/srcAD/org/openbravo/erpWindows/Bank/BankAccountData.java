...
Create a registry
 */
  public static BankAccountData[] set(String cBankId, String currentbalance, String cCurrencyId, String accountno, String codeaccount, String digitcontrol, String genericaccount, String iban, String cdtrschmeident, String showiban, String adOrgId, String isdefault, String updatedby, String updatedbyr, String created, String showgeneric, String showspanish, String creditlimit, String isactive, String bankaccounttype, String displayedaccount, String cBankaccountId, String createdby, String createdbyr, String adClientId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Digitcontrol = (?) , AccountNo = (?) , Codeaccount = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , C_Bank_ID = (?) , IsActive = (?) , ShowSpanish = (?) , BankAccountType = (?) , IsDefault = (?) , C_Currency_ID = (?) , GenericAccount = (?) , ShowGeneric = (?) , Iban = (?) , ShowIBAN = (?) , DisplayedAccount = (?) , CreditLimit = TO_NUMBER(?) , CdtrSchmeIdent = (?) , CurrentBalance = TO_NUMBER(?) , C_BankAccount_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BankAccount.C_BankAccount_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Digitcontrol, Codeaccount, AccountNo, AD_Client_ID, AD_Org_ID, C_Bank_ID, IsActive, ShowSpanish, BankAccountType, IsDefault, C_Currency_ID, GenericAccount, ShowGeneric, Iban, ShowIBAN, DisplayedAccount, CreditLimit, CdtrSchmeIdent, C_BankAccount_ID, CurrentBalance, created, createdby, updated, updatedBy)" +
