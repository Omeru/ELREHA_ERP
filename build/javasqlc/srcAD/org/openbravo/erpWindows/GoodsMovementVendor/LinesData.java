...
Create a registry
 */
  public static LinesData[] set(String mInoutId, String line, String movementqty, String mLocatorId, String mLocatorIdr, String mInoutIdr, String mInoutlineId, String cUomId, String mProductUomId, String updatedby, String updatedbyr, String cOrderlineId, String cOrderlineIdr, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String cProjecttaskId, String isinvoiced, String mProductId, String mProductIdr, String isactive, String quantityorder, String isdescription, String cProjectId, String cProjectIdr, String adOrgId, String createdby, String createdbyr, String aAssetId, String adClientId, String description)    throws ServletException {
...
Select for auxiliar field
 */
  public static String selectDefF345198A17D24EE88F669F7698A01D10(ConnectionProvider connectionProvider, String m_inout_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOutLine" +
      "        SET IsDescription = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , M_InOut_ID = (?) , C_OrderLine_ID = (?) , Description = (?) , Line = TO_NUMBER(?) , M_Locator_ID = (?) , M_Product_ID = (?) , M_AttributeSetInstance_ID = (?) , QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , MovementQty = TO_NUMBER(?) , C_UOM_ID = (?) , A_Asset_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , M_InOutLine_ID = (?) , IsActive = (?) , IsInvoiced = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_InOutLine.M_InOutLine_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (IsDescription, AD_Client_ID, AD_Org_ID, M_InOut_ID, C_OrderLine_ID, Description, Line, M_Locator_ID, M_Product_ID, M_AttributeSetInstance_ID, QuantityOrder, M_Product_Uom_Id, MovementQty, C_UOM_ID, A_Asset_ID, C_Project_ID, C_Projecttask_ID, M_InOutLine_ID, IsActive, IsInvoiced, created, createdby, updated, updatedBy)" +
