...
WAD Generated class
 */
class CalloutMappingData implements FieldProvider {
static Logger log4j = Logger.getLogger(CalloutMappingData.class);
...
Select for edit
 */
  public static CalloutMappingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adModelObjectId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static CalloutMappingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adModelObjectId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        CalloutMappingData objectCalloutMappingData = new CalloutMappingData();
        objectCalloutMappingData.created = UtilSql.getValue(result, "created");
        objectCalloutMappingData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectCalloutMappingData.updated = UtilSql.getValue(result, "updated");
        objectCalloutMappingData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectCalloutMappingData.updatedby = UtilSql.getValue(result, "updatedby");
        objectCalloutMappingData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectCalloutMappingData.adModelObjectMappingId = UtilSql.getValue(result, "ad_model_object_mapping_id");
        objectCalloutMappingData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectCalloutMappingData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        objectCalloutMappingData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectCalloutMappingData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
        objectCalloutMappingData.isactive = UtilSql.getValue(result, "isactive");
        objectCalloutMappingData.adModelObjectId = UtilSql.getValue(result, "ad_model_object_id");
        objectCalloutMappingData.adModelObjectIdr = UtilSql.getValue(result, "ad_model_object_idr");
        objectCalloutMappingData.mappingname = UtilSql.getValue(result, "mappingname");
        objectCalloutMappingData.isdefault = UtilSql.getValue(result, "isdefault");
        objectCalloutMappingData.language = UtilSql.getValue(result, "language");
        objectCalloutMappingData.adUserClient = "";
        objectCalloutMappingData.adOrgClient = "";
        objectCalloutMappingData.createdby = "";
        objectCalloutMappingData.trBgcolor = "";
        objectCalloutMappingData.totalCount = "";
        objectCalloutMappingData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectCalloutMappingData);
    ...
    CalloutMappingData objectCalloutMappingData[] = new CalloutMappingData[vector.size()];
    vector.copyInto(objectCalloutMappingData);
    return(objectCalloutMappingData);
  }

/**
Create a registry
 */
  public static CalloutMappingData[] set(String adModelObjectId, String adClientId, String adOrgId, String mappingname, String isdefault, String adModelObjectMappingId, String createdby, String createdbyr, String updatedby, String updatedbyr, String isactive)    throws ServletException {
    CalloutMappingData objectCalloutMappingData[] = new CalloutMappingData[1];
    objectCalloutMappingData[0] = new CalloutMappingData();
    objectCalloutMappingData[0].created = "";
    objectCalloutMappingData[0].createdbyr = createdbyr;
    objectCalloutMappingData[0].updated = "";
    objectCalloutMappingData[0].updatedTimeStamp = "";
    objectCalloutMappingData[0].updatedby = updatedby;
    objectCalloutMappingData[0].updatedbyr = updatedbyr;
    objectCalloutMappingData[0].adModelObjectMappingId = adModelObjectMappingId;
    objectCalloutMappingData[0].adClientId = adClientId;
    objectCalloutMappingData[0].adClientIdr = "";
    objectCalloutMappingData[0].adOrgId = adOrgId;
    objectCalloutMappingData[0].adOrgIdr = "";
    objectCalloutMappingData[0].isactive = isactive;
    objectCalloutMappingData[0].adModelObjectId = adModelObjectId;
    objectCalloutMappingData[0].adModelObjectIdr = "";
    objectCalloutMappingData[0].mappingname = mappingname;
    objectCalloutMappingData[0].isdefault = isdefault;
    objectCalloutMappingData[0].language = "";
    return objectCalloutMappingData;
  }
