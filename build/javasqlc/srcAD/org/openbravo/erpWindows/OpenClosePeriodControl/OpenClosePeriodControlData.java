  ...
  public static OpenClosePeriodControlData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectOpenClosePeriodControlData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
...
Create a registry
 */
  public static OpenClosePeriodControlData[] set(String createdby, String cCalendarId, String adOrgId, String adClientId, String periodaction, String updatedby, String cYearId, String description, String cPeriodcontrolLogId, String isactive, String periodno, String processed, String docbasetype, String isrecursive, String processing)    throws ServletException {
    ...
    objectOpenClosePeriodControlData[0].adClientIdr = "";
