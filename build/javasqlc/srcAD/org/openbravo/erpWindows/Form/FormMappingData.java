...
WAD Generated class
 */
class FormMappingData implements FieldProvider {
static Logger log4j = Logger.getLogger(FormMappingData.class);
...
Select for edit
 */
  public static FormMappingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adModelObjectId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static FormMappingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adModelObjectId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        FormMappingData objectFormMappingData = new FormMappingData();
        objectFormMappingData.created = UtilSql.getValue(result, "created");
        objectFormMappingData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectFormMappingData.updated = UtilSql.getValue(result, "updated");
        objectFormMappingData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectFormMappingData.updatedby = UtilSql.getValue(result, "updatedby");
        objectFormMappingData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectFormMappingData.adModelObjectMappingId = UtilSql.getValue(result, "ad_model_object_mapping_id");
        objectFormMappingData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectFormMappingData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        objectFormMappingData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectFormMappingData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
        objectFormMappingData.isactive = UtilSql.getValue(result, "isactive");
        objectFormMappingData.adModelObjectId = UtilSql.getValue(result, "ad_model_object_id");
        objectFormMappingData.adModelObjectIdr = UtilSql.getValue(result, "ad_model_object_idr");
        objectFormMappingData.mappingname = UtilSql.getValue(result, "mappingname");
        objectFormMappingData.isdefault = UtilSql.getValue(result, "isdefault");
        objectFormMappingData.language = UtilSql.getValue(result, "language");
        objectFormMappingData.adUserClient = "";
        objectFormMappingData.adOrgClient = "";
        objectFormMappingData.createdby = "";
        objectFormMappingData.trBgcolor = "";
        objectFormMappingData.totalCount = "";
        objectFormMappingData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectFormMappingData);
    ...
    FormMappingData objectFormMappingData[] = new FormMappingData[vector.size()];
    vector.copyInto(objectFormMappingData);
    return(objectFormMappingData);
  }

/**
Create a registry
 */
  public static FormMappingData[] set(String adModelObjectId, String adClientId, String adOrgId, String mappingname, String isdefault, String adModelObjectMappingId, String createdby, String createdbyr, String updatedby, String updatedbyr, String isactive)    throws ServletException {
    FormMappingData objectFormMappingData[] = new FormMappingData[1];
    objectFormMappingData[0] = new FormMappingData();
    objectFormMappingData[0].created = "";
    objectFormMappingData[0].createdbyr = createdbyr;
    objectFormMappingData[0].updated = "";
    objectFormMappingData[0].updatedTimeStamp = "";
    objectFormMappingData[0].updatedby = updatedby;
    objectFormMappingData[0].updatedbyr = updatedbyr;
    objectFormMappingData[0].adModelObjectMappingId = adModelObjectMappingId;
    objectFormMappingData[0].adClientId = adClientId;
    objectFormMappingData[0].adClientIdr = "";
    objectFormMappingData[0].adOrgId = adOrgId;
    objectFormMappingData[0].adOrgIdr = "";
    objectFormMappingData[0].isactive = isactive;
    objectFormMappingData[0].adModelObjectId = adModelObjectId;
    objectFormMappingData[0].adModelObjectIdr = "";
    objectFormMappingData[0].mappingname = mappingname;
    objectFormMappingData[0].isdefault = isdefault;
    objectFormMappingData[0].language = "";
    return objectFormMappingData;
  }
