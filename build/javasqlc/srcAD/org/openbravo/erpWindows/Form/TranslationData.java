...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adFormId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adFormId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adFormId==null || adFormId.equals(""))?"":"  AND AD_Form_Trl.AD_Form_ID = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTranslationData.adFormTrlId = UtilSql.getValue(result, "ad_form_trl_id");
        ...
        objectTranslationData.adFormId = UtilSql.getValue(result, "ad_form_id");
        objectTranslationData.adFormIdr = UtilSql.getValue(result, "ad_form_idr");
...
Create a registry
 */
  public static TranslationData[] set(String adFormId, String description, String updatedby, String updatedbyr, String adClientId, String adOrgId, String adFormTrlId, String name, String createdby, String createdbyr, String adLanguage, String help, String istranslated, String isactive)    throws ServletException {
    ...
    objectTranslationData[0].adFormTrlId = adFormTrlId;
    ...
    objectTranslationData[0].adFormId = adFormId;
    objectTranslationData[0].adFormIdr = "";
 ...
 */
  public static String selectParentID(ConnectionProvider connectionProvider, String key)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT AD_Form_Trl.AD_Form_ID AS NAME" +
      "        FROM AD_Form_Trl" +
