...
Create a registry
 */
  public static LinesData[] set(String cBpartnerId, String cProjectphaseId, String sTimetypeId, String cUomId, String description, String cProjecttaskId, String updatedby, String updatedbyr, String cActivityId, String line, String note, String sTimeexpenselineId, String cCurrencyId, String cBpartnerIdr, String isactive, String convertedamt, String invoiceprice, String expenseamt, String dateexpense, String adOrgId, String sTimeexpenseId, String cInvoicelineId, String mProductId, String isinvoiced, String createdby, String createdbyr, String istimereport, String adClientId, String qty, String cCampaignId, String cProjectId, String sResourceassignmentId, String cOrderlineId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Campaign_ID = (?) , C_Activity_ID = (?) , S_TimeType_ID = (?) , C_OrderLine_ID = (?) , S_ResourceAssignment_ID = (?) , C_InvoiceLine_ID = (?) , S_TimeExpenseLine_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , S_TimeExpense_ID = (?) , Line = TO_NUMBER(?) , IsTimeReport = (?) , IsInvoiced = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , C_Currency_ID = (?) , C_UOM_ID = (?) , InvoicePrice = TO_NUMBER(?) , DateExpense = TO_DATE(?) , ExpenseAmt = TO_NUMBER(?) , ConvertedAmt = TO_NUMBER(?) , Description = (?) , Note = (?) , C_Project_ID = (?) , C_BPartner_ID = (?) , C_ProjectPhase_ID = (?) , C_ProjectTask_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE S_TimeExpenseLine.S_TimeExpenseLine_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Campaign_ID, C_Activity_ID, S_TimeType_ID, C_OrderLine_ID, S_ResourceAssignment_ID, C_InvoiceLine_ID, S_TimeExpenseLine_ID, IsActive, AD_Client_ID, AD_Org_ID, S_TimeExpense_ID, Line, IsTimeReport, IsInvoiced, M_Product_ID, Qty, C_Currency_ID, C_UOM_ID, InvoicePrice, DateExpense, ExpenseAmt, ConvertedAmt, Description, Note, C_Project_ID, C_BPartner_ID, C_ProjectPhase_ID, C_ProjectTask_ID, created, createdby, updated, updatedBy)" +
