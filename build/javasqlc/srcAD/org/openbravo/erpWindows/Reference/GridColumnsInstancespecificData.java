 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Ref_Gridcolumn_ID = (?) , AD_Element_ID = (?) , Isactive = (?) , Line = TO_NUMBER(?) , Visiblesetting = (?) , Colspan = TO_NUMBER(?) , Template = (?) , Issortable = (?) , Onchangeevent = (?) , Referenceurl = (?) , Rowkeysuffix = (?) , Isrowkey = (?) , Maxlength = TO_NUMBER(?) , Issecondheader = (?) , Issplitgroup = (?) , Colreference = (?) , AD_Client_ID = (?) , AD_Val_Rule_ID = (?) , Isdisplayed = (?) , AD_Ref_Gridcolumninstance_ID = (?) , Mandantorylogic = (?) , Readonlylogic = (?) , Isinheader = (?) , Name = (?) , Readonly = (?) , Required = (?) , AD_Org_ID = (?) , Editsetting = (?) , Headertext = (?) , Defaultvalue = (?) , Includesemptyitem = (?) , AD_Table_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_ref_gridcolumninstance.AD_Ref_Gridcolumninstance_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Ref_Gridcolumn_ID, AD_Element_ID, Isactive, Line, Visiblesetting, Colspan, Template, Issortable, Onchangeevent, Referenceurl, Rowkeysuffix, Isrowkey, Maxlength, Issecondheader, Issplitgroup, Colreference, AD_Client_ID, AD_Val_Rule_ID, Isdisplayed, AD_Ref_Gridcolumninstance_ID, Mandantorylogic, Readonlylogic, Isinheader, Name, Readonly, Required, AD_Org_ID, Editsetting, Headertext, Defaultvalue, Includesemptyitem, AD_Table_ID, created, createdby, updated, updatedBy)" +
