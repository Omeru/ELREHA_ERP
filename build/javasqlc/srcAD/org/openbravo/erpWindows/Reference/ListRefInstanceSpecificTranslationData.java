  ...
  public static ListRefInstanceSpecificTranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRefListinstanceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectListRefInstanceSpecificTranslationData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
...
Create a registry
 */
  public static ListRefInstanceSpecificTranslationData[] set(String adRefListinstanceId, String adOrgId, String updatedby, String updatedbyr, String adClientId, String adRefListinstanceTrlId, String isactive, String adLanguage, String name, String createdby, String createdbyr)    throws ServletException {
    ...
    objectListRefInstanceSpecificTranslationData[0].adClientIdr = "";
