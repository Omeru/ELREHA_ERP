 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Dataset" +
      "        SET AD_Dataset_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , IsActive = (?) , AD_Module_ID = (?) , Value = (?) , Name = (?) , Description = (?) , Accesslevel = (?) , ExportAllowed = (?) , Export = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Dataset_ID, AD_Client_ID, AD_Org_ID, IsActive, AD_Module_ID, Value, Name, Description, Accesslevel, ExportAllowed, Export, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
