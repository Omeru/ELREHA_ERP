...
Create a registry
 */
  public static ProductsData[] set(String mOfferId, String adOrgId, String cUomId, String mOfferProductId, String mProductId, String mProductIdr, String updatedby, String updatedbyr, String createdby, String createdbyr, String adClientId, String isactive, String mManufacturerId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Offer_ID = (?) , M_Product_ID = (?) , C_Uom_ID = (?) , M_Manufacturer_ID = (?) , IsActive = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , M_Offer_Product_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_Offer_Product.M_Offer_Product_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Offer_ID, M_Product_ID, C_Uom_ID, M_Manufacturer_ID, IsActive, AD_Org_ID, AD_Client_ID, M_Offer_Product_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
