...
Create a registry
 */
  public static HeaderData[] set(String cBpartnerId, String cBpartnerIdr, String priorityrule, String dropshipLocationId, String billtoId, String adClientId, String cIncotermsId, String isselected, String mShipperId, String freightamt, String istaxincluded, String qty, String cProjecttaskId, String orderselfjoin, String user2Id, String cProjectphaseId, String cChargeId, String mProductId, String docaction, String totallines, String ispaid, String enddate, String weightUom, String proposalstatus, String posted, String iscompletelyinvoiced, String weight, String user1Id, String name, String closeproject, String invoicefrequence, String chargeamt, String cBpartnerLocationId, String cCampaignId, String internalnote, String btncopytemplate, String isdiscountprinted, String dropshipBpartnerId, String isrecharge, String totallinesonetime, String freightcostrule, String cBidprojectId, String datepromised, String cPaymenttermId, String contractdate, String docstatus, String paymentrule, String cProjectId, String cProjectIdr, String transactiondate, String lostproposalfixedreason, String updatedby, String updatedbyr, String deliveryLocationId, String salesrepId, String poreference, String schedtransactiondate, String mWarehouseId, String copyfrompo, String copyfrom, String cOrderId, String isdelivered, String issotrx, String deliveryrule, String isselfservice, String createdby, String createdbyr, String dateordered, String generatetemplate, String cActivityId, String monthlyDay, String documentno, String completeordervalue, String dropshipUserId, String dateacct, String cCurrencyId, String adOrgId, String totalpaid, String grandtotalonetime, String bpzipcode, String cDoctypetargetId, String invoicerule, String deliverynotes, String scheddeliverydate, String isinvoiceafterfirstcycle, String incotermsdescription, String mPricelistId, String invoicedamt, String processed, String estpropability, String deliveryviarule, String weeklyDay, String description, String isprinted, String dateprinted, String grandtotal, String isinvoiced, String lostproposalreason, String isactive, String cDoctypeId, String adOrgtrxId, String aAssetId, String adUserId, String quarterlyMonth, String firstschedinvoicedate, String generateproject, String processing, String yearlyMonth)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Order" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , DocumentNo = (?) , POReference = (?) , DateOrdered = TO_DATE(?) , C_DocTypeTarget_ID = (?) , Name = (?) , C_DocType_ID = (?) , DocStatus = (?) , Description = (?) , Deliverynotes = (?) , Internalnote = (?) , C_BPartner_ID = (?) , bpzipcode = (?) , BillTo_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , SalesRep_ID = (?) , M_PriceList_ID = (?) , IsDiscountPrinted = (?) , InvoiceRule = (?) , Estpropability = (?) , M_Warehouse_ID = (?) , C_Currency_ID = (?) , DeliveryRule = (?) , PriorityRule = (?) , PaymentRule = (?) , C_PaymentTerm_ID = (?) , C_Incoterms_ID = (?) , Delivery_Location_ID = (?) , DeliveryViaRule = (?) , M_Shipper_ID = (?) , Weight = TO_NUMBER(?) , Weight_Uom = (?) , FreightCostRule = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , FreightAmt = TO_NUMBER(?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , Firstschedinvoicedate = TO_DATE(?) , DatePromised = TO_DATE(?) , SchedTransactionDate = TO_DATE(?) , TransactionDate = TO_DATE(?) , Contractdate = TO_DATE(?) , Enddate = TO_DATE(?) , Invoicefrequence = (?) , Isinvoiceafterfirstcycle = (?) , Quarterly_Month = (?) , Yearly_Month = (?) , Weekly_Day = (?) , Monthly_Day = TO_NUMBER(?) , Proposalstatus = (?) , Lostproposalfixedreason = (?) , Lostproposalreason = (?) , Totallinesonetime = TO_NUMBER(?) , Grandtotalonetime = TO_NUMBER(?) , TotalLines = TO_NUMBER(?) , GrandTotal = TO_NUMBER(?) , InvoicedAmt = TO_NUMBER(?) , TotalPaid = TO_NUMBER(?) , CompleteOrderValue = TO_NUMBER(?) , BtnCopyTemplate = (?) , CopyFrom = (?) , User2_ID = (?) , Ispaid = (?) , C_Activity_ID = (?) , Generatetemplate = (?) , Processed = (?) , Processing = (?) , IsDelivered = (?) , DateAcct = TO_DATE(?) , IsSelfService = (?) , C_Order_ID = (?) , Generateproject = (?) , DropShip_Location_ID = (?) , C_Projectphase_ID = (?) , DropShip_User_ID = (?) , IsInvoiced = (?) , IsCompletelyInvoiced = (?) , DatePrinted = TO_DATE(?) , Posted = (?) , IsPrinted = (?) , C_Campaign_ID = (?) , User1_ID = (?) , DropShip_BPartner_ID = (?) , CopyFromPO = (?) , IsSOTrx = (?) , C_Charge_ID = (?) , Isrecharge = (?) , IsTaxIncluded = (?) , A_Asset_ID = (?) , SchedDeliveryDate = TO_DATE(?) , C_Bidproject_ID = (?) , Orderselfjoin = (?) , IsActive = (?) , DocAction = (?) , Incotermsdescription = (?) , Closeproject = (?) , ChargeAmt = TO_NUMBER(?) , AD_OrgTrx_ID = (?) , IsSelected = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO C_Order " +
      "        (AD_Client_ID, AD_Org_ID, DocumentNo, POReference, DateOrdered, C_DocTypeTarget_ID, Name, C_DocType_ID, DocStatus, Description, Deliverynotes, Internalnote, C_BPartner_ID, bpzipcode, BillTo_ID, C_BPartner_Location_ID, AD_User_ID, SalesRep_ID, M_PriceList_ID, IsDiscountPrinted, InvoiceRule, Estpropability, M_Warehouse_ID, C_Currency_ID, DeliveryRule, PriorityRule, PaymentRule, C_PaymentTerm_ID, C_Incoterms_ID, Delivery_Location_ID, DeliveryViaRule, M_Shipper_ID, Weight, Weight_Uom, FreightCostRule, M_Product_ID, Qty, FreightAmt, C_Project_ID, C_Projecttask_ID, Firstschedinvoicedate, DatePromised, SchedTransactionDate, TransactionDate, Contractdate, Enddate, Invoicefrequence, Isinvoiceafterfirstcycle, Quarterly_Month, Yearly_Month, Weekly_Day, Monthly_Day, Proposalstatus, Lostproposalfixedreason, Lostproposalreason, Totallinesonetime, Grandtotalonetime, TotalLines, GrandTotal, InvoicedAmt, TotalPaid, CompleteOrderValue, BtnCopyTemplate, CopyFrom, User2_ID, Ispaid, C_Activity_ID, Generatetemplate, Processed, Processing, IsDelivered, DateAcct, IsSelfService, C_Order_ID, Generateproject, DropShip_Location_ID, C_Projectphase_ID, DropShip_User_ID, IsInvoiced, IsCompletelyInvoiced, DatePrinted, Posted, IsPrinted, C_Campaign_ID, User1_ID, DropShip_BPartner_ID, CopyFromPO, IsSOTrx, C_Charge_ID, Isrecharge, IsTaxIncluded, A_Asset_ID, SchedDeliveryDate, C_Bidproject_ID, Orderselfjoin, IsActive, DocAction, Incotermsdescription, Closeproject, ChargeAmt, AD_OrgTrx_ID, IsSelected, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), now(), ?, now(), ?)";
