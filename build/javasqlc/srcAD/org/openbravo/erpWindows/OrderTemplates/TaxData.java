...
Create a registry
 */
  public static TaxData[] set(String cOrderId, String taxbaseamt, String cTaxId, String line, String adOrgId, String reversetaxamt, String adClientId, String taxamt, String cOrderIdr, String createdby, String createdbyr, String cOrdertaxId, String isonetimeposition, String isactive, String updatedby, String updatedbyr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_OrderTax" +
      "        SET AD_Client_ID = (?) , Line = TO_NUMBER(?) , AD_Org_ID = (?) , C_Order_ID = (?) , C_Tax_ID = (?) , TaxAmt = TO_NUMBER(?) , TaxBaseAmt = TO_NUMBER(?) , Reversetaxamt = TO_NUMBER(?) , Isonetimeposition = (?) , C_OrderTax_ID = (?) , IsActive = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_OrderTax.C_OrderTax_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, Line, AD_Org_ID, C_Order_ID, C_Tax_ID, TaxAmt, TaxBaseAmt, Reversetaxamt, Isonetimeposition, C_OrderTax_ID, IsActive, created, createdby, updated, updatedBy)" +
