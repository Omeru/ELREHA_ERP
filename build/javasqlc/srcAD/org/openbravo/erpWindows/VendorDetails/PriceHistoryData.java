...
Select for edit
 */
  public static PriceHistoryData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static PriceHistoryData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((cBpartnerId==null || cBpartnerId.equals(""))?"":"  AND m_product_po_history.C_Bpartner_ID = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectPriceHistoryData.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
        objectPriceHistoryData.cBpartnerIdr = UtilSql.getValue(result, "c_bpartner_idr");
...
Create a registry
 */
  public static PriceHistoryData[] set(String cBpartnerId, String validfrom, String updatedby, String updatedbyr, String mProductId, String mProductIdr, String adClientId, String mProductPoId, String pricelist, String createdby, String createdbyr, String pricepo, String adOrgId, String mProductPoHistoryId, String cBpartnerIdr, String isactive)    throws ServletException {
    ...
    objectPriceHistoryData[0].cBpartnerId = cBpartnerId;
    objectPriceHistoryData[0].cBpartnerIdr = cBpartnerIdr;
...
Select for auxiliar field
 */
  public static String selectDefD7DE14B66A934CE7BA7CCECA17E747AE_1(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef0159BAE1C67F4700B8AF3F96579AB04C_2(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef5406A6D042A34DB99BEE217581B7D16B_3(ConnectionProvider connectionProvider, String C_Bpartner_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
