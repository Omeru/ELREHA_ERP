...
Create a registry
 */
  public static HeaderData[] set(String shareofturnoverpartner, String cCommissionId, String listdetails, String updatedby, String updatedbyr, String isactive, String adClientId, String datelastrun, String mProductId, String mProductIdr, String shareofturnoverpercent, String name, String processing, String createdby, String createdbyr, String cBpartnerId, String cBpartnerIdr, String docbasistype, String frequencytype, String createfrom, String adOrgId, String cCurrencyId, String description)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Commission" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , Name = (?) , Description = (?) , IsActive = (?) , C_BPartner_ID = (?) , C_Currency_ID = (?) , M_Product_ID = (?) , DocBasisType = (?) , FrequencyType = (?) , Shareofturnoverpartner = (?) , Shareofturnoverpercent = TO_NUMBER(?) , Processing = (?) , DateLastRun = TO_DATE(?) , ListDetails = (?) , CreateFrom = (?) , C_Commission_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, Name, Description, IsActive, C_BPartner_ID, C_Currency_ID, M_Product_ID, DocBasisType, FrequencyType, Shareofturnoverpartner, Shareofturnoverpercent, Processing, DateLastRun, ListDetails, CreateFrom, C_Commission_ID, created, createdby, updated, updatedBy)" +
