...
Create a registry
 */
  public static LocationAddressFC72B03C5A4041768780421B1BC22416Data[] set(String cBpartnerId, String cBpartnerIdr, String isactive, String istaxlocation, String adOrgId, String isshipto, String cSalesregionId, String phone2, String cBpartnerLocationId, String fax, String adClientId, String isheadquarter, String name, String cLocationId, String cLocationIdr, String ispayfrom, String isbillto, String phone, String isremitto, String createdby, String createdbyr, String upc, String updatedby, String updatedbyr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_BPartner_ID = (?) , UPC = (?) , Name = (?) , IsActive = (?) , C_Location_ID = (?) , Phone = (?) , Phone2 = (?) , Fax = (?) , IsTaxLocation = (?) , IsHeadquarter = (?) , IsBillTo = (?) , C_SalesRegion_ID = (?) , IsPayFrom = (?) , AD_Org_ID = (?) , IsShipTo = (?) , C_BPartner_Location_ID = (?) , IsRemitTo = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BPartner_Location.C_BPartner_Location_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_BPartner_ID, UPC, Name, IsActive, C_Location_ID, Phone, Phone2, Fax, IsTaxLocation, IsHeadquarter, IsBillTo, C_SalesRegion_ID, IsPayFrom, AD_Org_ID, IsShipTo, C_BPartner_Location_ID, IsRemitTo, AD_Client_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
