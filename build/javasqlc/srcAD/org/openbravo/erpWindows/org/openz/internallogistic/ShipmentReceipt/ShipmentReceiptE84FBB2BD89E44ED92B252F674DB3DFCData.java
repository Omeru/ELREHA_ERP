...
Create a registry
 */
  public static ShipmentReceiptE84FBB2BD89E44ED92B252F674DB3DFCData[] set(String description, String adOrgId, String mWarehouseId, String islogistic, String docstatus, String processing, String issotrx, String isactive, String cDoctypeId, String docaction, String docactionBtn, String updatedby, String updatedbyr, String processed, String mShipperId, String cProjecttaskId, String ilsInoutVId, String createdby, String createdbyr, String movementtype, String aAssetId, String cProjectId, String adClientId, String documentno, String movementdate, String cOrderId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE ils_inout_v" +
      "        SET C_Project_ID = (?) , AD_Org_ID = (?) , DocumentNo = (?) , Islogistic = (?) , C_DocType_ID = (?) , MovementDate = TO_DATE(?) , M_Shipper_ID = (?) , M_Warehouse_ID = (?) , DocStatus = (?) , MovementType = (?) , DocAction = (?) , A_Asset_ID = (?) , C_Projecttask_ID = (?) , ILS_Inout_V_ID = (?) , C_Order_ID = (?) , Processed = (?) , Processing = (?) , IsActive = (?) , AD_Client_ID = (?) , IsSOTrx = (?) , Description = (?) , updated = now(), updatedby = ? " +
      "        WHERE ils_inout_v.ILS_Inout_V_ID = ? " +
      "        AND ils_inout_v.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Project_ID, AD_Org_ID, DocumentNo, Islogistic, C_DocType_ID, MovementDate, M_Shipper_ID, M_Warehouse_ID, DocStatus, MovementType, DocAction, A_Asset_ID, C_Projecttask_ID, ILS_Inout_V_ID, C_Order_ID, Processed, Processing, IsActive, AD_Client_ID, IsSOTrx, Description, created, createdby, updated, updatedBy)" +
