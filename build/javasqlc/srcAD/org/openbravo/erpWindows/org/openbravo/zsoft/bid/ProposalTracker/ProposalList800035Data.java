 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Lastname = (?) , Fromdatesend = TO_DATE(?) , Todatesend = TO_DATE(?) , C_Projectproposal_ID = (?) , Firstname = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , C_Project_ID = (?) , C_BPartner_ID = (?) , IsSOTrx = (?) , Datesend = TO_DATE(?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Lastname, Fromdatesend, Todatesend, C_Projectproposal_ID, Firstname, AD_Client_ID, AD_Org_ID, C_Project_ID, C_BPartner_ID, IsSOTrx, Datesend, C_BPartner_Location_ID, AD_User_ID, created, createdby, updated, updatedBy)" +
