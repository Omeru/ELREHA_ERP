 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssm_Workstep_Prp_V_ID = (?) , IsActive = (?) , C_Salary_Category_ID = (?) , AverageDuration = TO_NUMBER(?) , DurationUnit = (?) , zssm_section_id = (?) , AD_Client_ID = (?) , Zssm_WorkstepActivities_V_ID = (?) , Planned_Durationunit = (?) , Costuom = (?) , Planned_Averageduration = TO_NUMBER(?) , Planned_Quantity = TO_NUMBER(?) , AD_Org_ID = (?) , Quantity = TO_NUMBER(?) , Zspm_PTaskHRPlan_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssm_workstepactivities_v.Zssm_WorkstepActivities_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssm_Workstep_Prp_V_ID, IsActive, C_Salary_Category_ID, AverageDuration, DurationUnit, zssm_section_id, AD_Client_ID, Zssm_WorkstepActivities_V_ID, Planned_Durationunit, Costuom, Planned_Averageduration, Planned_Quantity, AD_Org_ID, Quantity, Zspm_PTaskHRPlan_ID, created, createdby, updated, updatedBy)" +
