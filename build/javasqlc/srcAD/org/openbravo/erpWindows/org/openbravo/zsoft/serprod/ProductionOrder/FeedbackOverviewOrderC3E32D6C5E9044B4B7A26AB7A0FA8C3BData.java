 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssm_Feedback_V_ID = (?) , Zssm_Productionorder_V_ID = (?) , AD_Client_ID = (?) , Zssm_Workstep_V_ID = (?) , Workdate = TO_DATE(?) , AD_Org_ID = (?) , Isactive = (?) , Hours = TO_NUMBER(?) , AD_User_ID = (?) , C_Salary_Category_ID = (?) , MA_Machine_ID = (?) , Description = (?) , Url = (?) , Actualcostamount = TO_NUMBER(?) , Hour_From = TO_TIMESTAMP(?,'HH24:MI:SS') , Hour_To = TO_TIMESTAMP(?,'HH24:MI:SS') , updated = now(), updatedby = ? " +
      "        WHERE zssm_feedback_v.Zssm_Feedback_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssm_Feedback_V_ID, Zssm_Productionorder_V_ID, AD_Client_ID, Zssm_Workstep_V_ID, Workdate, AD_Org_ID, Isactive, Hours, AD_User_ID, C_Salary_Category_ID, MA_Machine_ID, Description, Url, Actualcostamount, Hour_From, Hour_To, created, createdby, updated, updatedBy)" +
