...
Create a registry
 */
  public static Main8FBAA16AD68140C8AF41D76BB9B882F1Data[] set(String adClientId, String typeofcontact, String cBpartnerId, String cBpartnerIdr, String dateofcontact, String adOrgId, String zssiNotes4customerId, String createdby, String createdbyr, String contactto, String isactive, String zssiCrmTodosId, String followup, String description, String updatedby, String updatedbyr, String emp, String cProjectId, String cProjectIdr, String followupDone)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssi_Notes4customer_ID = (?) , C_Bpartner_ID = (?) , Dateofcontact = TO_DATE(?) , Typeofcontact = (?) , Followup = TO_DATE(?) , Contactto = (?) , Emp = (?) , Description = (?) , C_Project_ID = (?) , Followup_Done = (?) , AD_Org_ID = (?) , Isactive = (?) , Zssi_Crm_Todos_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssi_Notes4customer_ID, C_Bpartner_ID, Dateofcontact, Typeofcontact, Followup, Contactto, Emp, Description, C_Project_ID, Followup_Done, AD_Org_ID, Isactive, Zssi_Crm_Todos_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
