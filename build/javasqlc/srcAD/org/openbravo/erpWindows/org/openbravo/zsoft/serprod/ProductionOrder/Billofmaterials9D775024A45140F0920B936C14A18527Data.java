...
Create a registry
 */
  public static Billofmaterials9D775024A45140F0920B936C14A18527Data[] set(String zssmWorkstepVId, String qtyPlan, String zssmWorkstepbomVId, String qtyreserved, String qtyAvailable, String adOrgId, String qtyreceived, String rawmaterial, String description, String cutoff, String mProductId, String mProductIdr, String snrBatchmasterdataId, String snrBatchmasterdataIdr, String datePlan, String isactive, String line, String qtyInstock, String zspmProjecttaskbomId, String issuingLocator, String issuingLocatorr, String planrequisition, String createdby, String createdbyr, String mLocatorId, String receivingLocator, String receivingLocatorr, String actualcosamount, String qtyinrequisition, String constuctivemeasure, String updatedby, String updatedbyr, String adClientId, String quantity)    throws ServletException {
...
Select for auxiliar field
 */
  public static String selectDefD314156053604B6CA9FE8BDB4992BD80_1(ConnectionProvider connectionProvider, String SNR_Batchmasterdata_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
