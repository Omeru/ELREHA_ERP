...
Create a registry
 */
  public static SequencePlan9A80ADE423C244619A871098853BF405Data[] set(String zssmProductionplanVId, String sortno, String dependsontask, String adClientId, String zssmProductionplanTaskdepVId, String description, String createdby, String createdbyr, String isactive, String updatedby, String updatedbyr, String zssmProductionplanTaskId, String adOrgId, String zssmProductionplanTaskdepId, String stockrotation, String dependentstatuscheck)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Zssm_Productionplan_V_ID = (?) , Isactive = (?) , SortNo = TO_NUMBER(?) , DependsOnTask = (?) , Zssm_Productionplan_Task_ID = (?) , Description = (?) , StockRotation = (?) , DependentStatusCheck = (?) , Zssm_Productionplan_Taskdep_V_ID = (?) , Zssm_Productionplan_Taskdep_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssm_productionplan_taskdep_v.Zssm_Productionplan_Taskdep_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Zssm_Productionplan_V_ID, Isactive, SortNo, DependsOnTask, Zssm_Productionplan_Task_ID, Description, StockRotation, DependentStatusCheck, Zssm_Productionplan_Taskdep_V_ID, Zssm_Productionplan_Taskdep_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
