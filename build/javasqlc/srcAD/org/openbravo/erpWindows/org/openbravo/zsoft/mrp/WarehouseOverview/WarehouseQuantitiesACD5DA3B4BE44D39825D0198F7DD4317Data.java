...
Create a registry
 */
  public static WarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data[] set(String zssiOnhanqtyOverviewId, String mLocatorId, String mLocatorIdr, String mProductId, String mProductIdr, String qtyincomming, String cUomId, String createdby, String createdbyr, String qtyreserved, String updatedby, String updatedbyr, String qtyinflow, String qtyordered, String qtyinsale, String mProductCategoryId, String zssiOnhanqtyId, String mWarehouseId, String qtyoutflow, String adOrgId, String isactive, String adClientId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyonhand)    throws ServletException {
