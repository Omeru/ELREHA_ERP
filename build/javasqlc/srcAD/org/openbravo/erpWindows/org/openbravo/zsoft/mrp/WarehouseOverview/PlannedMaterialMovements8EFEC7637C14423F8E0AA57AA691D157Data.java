...
Create a registry
 */
  public static PlannedMaterialMovements8EFEC7637C14423F8E0AA57AA691D157Data[] set(String zssiOnhanqtyOverviewId, String updatedby, String updatedbyr, String documenttype, String isactive, String movementqty, String createdby, String createdbyr, String adClientId, String mrpInoutplanVId, String cUomId, String mProductId, String mProductIdr, String cBpartnerId, String cBpartnerIdr, String estimatedStockQty, String planneddate, String adOrgId, String cOrderlineId, String mWarehouseId, String cProjecttaskId, String mProductCategoryId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssi_Onhanqty_Overview_ID = (?) , MRP_Inoutplan_V_ID = (?) , M_Product_ID = (?) , AD_Client_ID = (?) , Planneddate = TO_DATE(?) , Movementqty = TO_NUMBER(?) , Estimated_Stock_Qty = TO_NUMBER(?) , Documenttype = (?) , C_Projecttask_ID = (?) , C_Orderline_ID = (?) , Isactive = (?) , C_Uom_ID = (?) , C_Bpartner_ID = (?) , M_Product_Category_ID = (?) , M_Warehouse_ID = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE mrp_inoutplan_v.MRP_Inoutplan_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssi_Onhanqty_Overview_ID, MRP_Inoutplan_V_ID, M_Product_ID, AD_Client_ID, Planneddate, Movementqty, Estimated_Stock_Qty, Documenttype, C_Projecttask_ID, C_Orderline_ID, Isactive, C_Uom_ID, C_Bpartner_ID, M_Product_Category_ID, M_Warehouse_ID, AD_Org_ID, created, createdby, updated, updatedBy)" +
