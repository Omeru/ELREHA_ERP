 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zspm_Recharge_View_ID, AD_Client_ID, AD_Org_ID, C_Project_ID, C_Projecttask_ID, Isactive, Qtyinvoiced, M_Product_ID, C_Order_ID, C_Orderline_ID, C_Bpartner_ID, Dateordered, Salesrep_ID, C_Invoice_ID, C_Invoiceline_ID, Description, Dateinvoiced, Linenetamt, Ispaid, Transactiondate, Recharge_Qtyinvoiced, Recharge_Product_ID, Totallines, Recharge_Invoice_ID, Grandtotal, Reinvoicedby_ID, Totalpaid, Recharge_Dateinvoiced, Recharge_Bpartner_ID, Recharge_Linenetamt, Recharge_Order_ID, Isrecharged, Norecharge, Norechargecomment, created, createdby, updated, updatedBy)" +
