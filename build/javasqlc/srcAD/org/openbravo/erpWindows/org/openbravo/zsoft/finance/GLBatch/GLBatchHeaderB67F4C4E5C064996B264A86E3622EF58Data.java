 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zsfi_Manualacct_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , DocumentNo = (?) , Isactive = (?) , Acctdate = TO_DATE(?) , Description = (?) , Glstatus = (?) , A_Asset_ID = (?) , C_Project_ID = (?) , C_Projectphase_ID = (?) , C_Projecttask_ID = (?) , Post = (?) , Unpost = (?) , Processing = (?) , Cancel = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zsfi_Manualacct_ID, AD_Client_ID, AD_Org_ID, DocumentNo, Isactive, Acctdate, Description, Glstatus, A_Asset_ID, C_Project_ID, C_Projectphase_ID, C_Projecttask_ID, Post, Unpost, Processing, Cancel, created, createdby, updated, updatedBy)" +
