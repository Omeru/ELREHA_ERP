 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO A_Asset " +
      "        (C_BPartner_ID, IsOwned, AssetDepreciationDate, IsDepreciated, A_Asset_ID, UseUnits, IsFullyDepreciated, C_BPartner_Location_ID, LifeUseUnits, IsInPosession, IsDisposed, AD_Client_ID, Datepurchased, AD_Org_ID, Datecancelled, Assettype, Amortizationstartdate, IsActive, Amortizationenddate, Issummary, Annualamortizationpercentage, AD_User_ID, C_Currency_ID, Value, AssetValueAmt, Name, Residualassetvalueamt, Help, Description, Acctvalueamt, C_Location_ID, Amortizationtype, LocationComment, Amortizationvalueamt, Lot, Assetschedule, VersionNo, DocumentNo, SerNo, AssetDisposalDate, Processed, GuaranteeDate, Profit, UseLifeYears, UseLifeMonths, Depreciatedvalue, AssetServiceDate, Depreciatedplan, Depreciatedpreviousamt, A_Asset_Group_ID, Amortizationcalctype, C_Project_ID, Iscostcenter, created, createdby, updated, updatedBy)" +
