 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET MRP_Deliveries_Expected_ID = (?) , M_Product_ID = (?) , Description = (?) , Salesrep_ID = (?) , Qtyordered = TO_NUMBER(?) , Qtydelivered = TO_NUMBER(?) , Isactive = (?) , C_Order_ID = (?) , AD_Client_ID = (?) , Scheddeliverydate = TO_DATE(?) , AD_Org_ID = (?) , C_Project_ID = (?) , A_Asset_ID = (?) , Datedelivered = TO_DATE(?) , Line = TO_NUMBER(?) , Overdue = (?) , Dateordered = TO_DATE(?) , Datepromised = TO_DATE(?) , C_Projectphase_ID = (?) , C_Projecttask_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (MRP_Deliveries_Expected_ID, M_Product_ID, Description, Salesrep_ID, Qtyordered, Qtydelivered, Isactive, C_Order_ID, AD_Client_ID, Scheddeliverydate, AD_Org_ID, C_Project_ID, A_Asset_ID, Datedelivered, Line, Overdue, Dateordered, Datepromised, C_Projectphase_ID, C_Projecttask_ID, created, createdby, updated, updatedBy)" +
