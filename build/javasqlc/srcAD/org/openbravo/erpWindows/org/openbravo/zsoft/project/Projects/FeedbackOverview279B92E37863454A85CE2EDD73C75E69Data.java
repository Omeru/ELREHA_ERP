...
Create a registry
 */
  public static FeedbackOverview279B92E37863454A85CE2EDD73C75E69Data[] set(String cProjecttaskId, String cSalaryCategoryId, String workdate, String description, String specialtime, String hourTo, String triggeramt, String adClientId, String dayhours, String updatedby, String updatedbyr, String isprocessed, String zspmPtaskfeedbacklineId, String hours, String createdby, String createdbyr, String adOrgId, String hourFrom, String actualcostamount, String costuom, String specialtime2, String url, String maMachineId, String isactive, String cProjectId, String cCalendareventId, String adUserId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Projecttask_ID = (?) , Workdate = TO_DATE(?) , Hours = TO_NUMBER(?) , Costuom = (?) , C_Salary_Category_ID = (?) , AD_User_ID = (?) , MA_Machine_ID = (?) , Description = (?) , Actualcostamount = TO_NUMBER(?) , Url = (?) , Hour_From = TO_TIMESTAMP(?,'HH24:MI:SS') , Hour_To = TO_TIMESTAMP(?,'HH24:MI:SS') , Isprocessed = (?) , C_Project_ID = (?) , Triggeramt = TO_NUMBER(?) , C_Calendarevent_ID = (?) , Isactive = (?) , Specialtime2 = TO_NUMBER(?) , Dayhours = (?) , Specialtime = TO_NUMBER(?) , AD_Org_ID = (?) , AD_Client_ID = (?) , Zspm_Ptaskfeedbackline_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zspm_ptaskfeedbackline.Zspm_Ptaskfeedbackline_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Projecttask_ID, Workdate, Hours, Costuom, C_Salary_Category_ID, AD_User_ID, MA_Machine_ID, Description, Actualcostamount, Url, Hour_From, Hour_To, Isprocessed, C_Project_ID, Triggeramt, C_Calendarevent_ID, Isactive, Specialtime2, Dayhours, Specialtime, AD_Org_ID, AD_Client_ID, Zspm_Ptaskfeedbackline_ID, created, createdby, updated, updatedBy)" +
