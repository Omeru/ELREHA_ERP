 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, IsActive, Value, ProjectCategory, Name, Description, Note, Projectstatus, Ishidden, Istaskssametime, Startdate, DateContract, DateFinish, M_Warehouse_ID, C_BPartner_ID, C_BPartner_Location_ID, POReference, MA_Machine_ID, A_Asset_ID, AD_User_ID, SalesRep_ID, Responsible_ID, Expensesplan, Expenses, Externalserviceplan, Externalservice, Materialcostplan, Materialcost, Servcostplan, Servcost, Machinecostplan, Machinecost, Indirectcostplan, Indirectcost, CommittedAmt, InvoicedAmt, PlannedMarginAmt, Marginamt, Plannedmarginpercent, Marginpercent, PlannedAmt, Actualcostamount, Estimatedamt, Percentdoneyet, Schedulestatus, ChangeProjectStatus, Closeproject, Reopenproject, Setprojecttype, C_PaymentTerm_ID, IsSummary, Projectkind, C_Campaign_ID, Processed, Servrevenue, PlannedQty, Expreinvoicing, Expexpenses, Servmargin, Expmargin, GenerateOrder, Projectphase, BillTo_ID, M_PriceList_ID, AccountNo, Document_Copies, PaymentRule, Invoice_ToProject, C_Location_ID, PlannedPOAmt, LastPlannedProposalDate, M_PriceList_Version_ID, GenerateTo, Publicprivate, M_Product_ID, IsCommitment, Qtyofproduct, C_Currency_ID, Processing, C_Phase_ID, ProjectBalanceAmt, C_ProjectPhase_ID, Createtemppricelist, InvoicedQty, C_ProjectType_ID, CommittedQty, C_Project_ID, AD_Client_ID, CopyFrom, IsCommitCeiling, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_DATE(?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), (?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), (?), (?), (?), now(), ?, now(), ?)";
