...
Create a registry
 */
  public static Header800258Data[] set(String simulate, String updatedby, String updatedbyr, String name, String vendorId, String description, String mProductId, String mProductIdr, String launchpo, String datedoc, String createdby, String createdbyr, String securitymargin, String mProductCategoryId, String timehorizon, String adClientId, String adOrgId, String mrpPlannerId, String cBpGroupId, String mWarehouseId, String cBpartnerId, String cBpartnerIdr, String mrpRunPurchaseId, String isactive)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , Name = (?) , Description = (?) , IsActive = (?) , DateDoc = TO_DATE(?) , Timehorizon = TO_NUMBER(?) , MRP_Planner_ID = (?) , Vendor_ID = (?) , M_Warehouse_ID = (?) , M_Product_ID = (?) , M_Product_Category_ID = (?) , C_BPartner_ID = (?) , C_BP_Group_ID = (?) , Simulate = (?) , Launchpo = (?) , Securitymargin = TO_NUMBER(?) , MRP_Run_Purchase_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, Name, Description, IsActive, DateDoc, Timehorizon, MRP_Planner_ID, Vendor_ID, M_Warehouse_ID, M_Product_ID, M_Product_Category_ID, C_BPartner_ID, C_BP_Group_ID, Simulate, Launchpo, Securitymargin, MRP_Run_Purchase_ID, created, createdby, updated, updatedBy)" +
