 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET MA_Indirect_Cost_ID = (?) , IsActive = (?) , DateFrom = TO_DATE(?) , Cost_Uom = (?) , empCost = TO_NUMBER(?) , Machinecost = TO_NUMBER(?) , Materialcost = TO_NUMBER(?) , Vendorcost = TO_NUMBER(?) , DateTo = TO_DATE(?) , Total = TO_NUMBER(?) , AD_Org_ID = (?) , Calculated = (?) , MA_Indirect_Cost_Value_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE MA_Indirect_Cost_Value.MA_Indirect_Cost_Value_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (MA_Indirect_Cost_ID, IsActive, DateFrom, Cost_Uom, empCost, Machinecost, Materialcost, Vendorcost, DateTo, Total, AD_Org_ID, Calculated, MA_Indirect_Cost_Value_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
