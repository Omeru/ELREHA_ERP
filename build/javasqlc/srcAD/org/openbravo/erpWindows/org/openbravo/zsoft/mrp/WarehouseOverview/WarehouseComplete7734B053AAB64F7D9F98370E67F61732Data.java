...
Create a registry
 */
  public static WarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[] set(String createdby, String createdbyr, String mProductId, String mProductIdr, String mWarehouseId, String qtyreserved, String updatedby, String updatedbyr, String cUomId, String qtyoutflow, String adOrgId, String zssiOnhanqtyOverviewId, String qtyonhand, String qtyordered, String qtyinflow, String qtyinsale, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyincomming, String isactive, String adClientId)    throws ServletException {
