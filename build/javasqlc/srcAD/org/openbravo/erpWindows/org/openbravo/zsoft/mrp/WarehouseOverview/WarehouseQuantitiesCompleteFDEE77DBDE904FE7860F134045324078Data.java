...
Create a registry
 */
  public static WarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[] set(String mLocatorId, String mLocatorIdr, String mProductId, String mProductIdr, String cUomId, String qtyincomming, String zssiOnhanqtyOverviewId, String createdby, String createdbyr, String qtyreserved, String updatedby, String updatedbyr, String qtyinflow, String qtyordered, String qtyinsale, String mProductCategoryId, String zssiOnhanqtyId, String qtyoutflow, String mWarehouseId, String adOrgId, String isactive, String adClientId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyonhand)    throws ServletException {
