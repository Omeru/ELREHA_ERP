 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_OrgTrx_ID = (?) , DropShip_User_ID = (?) , CopyFrom = (?) , DropShip_Location_ID = (?) , DropShip_BPartner_ID = (?) , IsSelfService = (?) , User2_ID = (?) , User1_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , DocumentNo = (?) , Incotermsdescription = (?) , POReference = (?) , Generatetemplate = (?) , DateOrdered = TO_DATE(?) , Transactionreference = (?) , CopyFromPO = (?) , C_DocTypeTarget_ID = (?) , A_Asset_ID = (?) , Name = (?) , C_DocType_ID = (?) , DocStatus = (?) , Description = (?) , Deliverynotes = (?) , Internalnote = (?) , C_BPartner_ID = (?) , bpzipcode = (?) , BillTo_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , SalesRep_ID = (?) , M_PriceList_ID = (?) , IsDiscountPrinted = (?) , InvoiceRule = (?) , Estpropability = (?) , M_Warehouse_ID = (?) , C_Currency_ID = (?) , DeliveryRule = (?) , PriorityRule = (?) , PaymentRule = (?) , C_PaymentTerm_ID = (?) , C_Incoterms_ID = (?) , Delivery_Location_ID = (?) , DeliveryViaRule = (?) , M_Shipper_ID = (?) , Weight = TO_NUMBER(?) , Weight_Uom = (?) , FreightCostRule = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , FreightAmt = TO_NUMBER(?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , Orderselfjoin = (?) , Firstschedinvoicedate = TO_DATE(?) , DatePromised = TO_DATE(?) , Scheddeliverydate = TO_DATE(?) , Schedtransactiondate = TO_DATE(?) , Transactiondate = TO_DATE(?) , Contractdate = TO_DATE(?) , Enddate = TO_DATE(?) , Invoicefrequence = (?) , C_Projectphase_ID = (?) , Isinvoiceafterfirstcycle = (?) , Quarterly_Month = (?) , Yearly_Month = (?) , C_Bidproject_ID = (?) , Weekly_Day = (?) , Monthly_Day = TO_NUMBER(?) , Proposalstatus = (?) , Lostproposalfixedreason = (?) , Lostproposalreason = (?) , Totallinesonetime = TO_NUMBER(?) , Grandtotalonetime = TO_NUMBER(?) , TotalLines = TO_NUMBER(?) , Generateproject = (?) , GrandTotal = TO_NUMBER(?) , Closeproject = (?) , Invoicedamt = TO_NUMBER(?) , Totalpaid = TO_NUMBER(?) , Completeordervalue = TO_NUMBER(?) , Deliverycomplete = (?) , Iscompletelyinvoiced = (?) , Juwimm_Completion = (?) , Juwimm_Time = (?) , Juwimm_Resources = (?) , Juwimm_Budget = (?) , Juwimm_Team_ID = (?) , Juwimm_Plannedgolive = TO_DATE(?) , Juwimm_Estgolive = TO_DATE(?) , Juwimm_Nextimpdate = TO_DATE(?) , Juwimm_Description = (?) , Juwimm_Plannedstart = TO_DATE(?) , Juwimm_Eststart = TO_DATE(?) , Juwimm_Milestone1 = (?) , Juwimm_Ms1planneddate = TO_DATE(?) , Juwimm_Ms1estdate = TO_DATE(?) , Juwimm_Milestone2 = (?) , Juwimm_Ms2planneddate = TO_DATE(?) , Juwimm_Ms2estdate = TO_DATE(?) , Juwimm_Milestone3 = (?) , Juwimm_Ms3planneddate = TO_DATE(?) , Juwimm_Ms3estdate = TO_DATE(?) , Juwimm_Milestone4 = (?) , Juwimm_Ms4planneddate = TO_DATE(?) , Juwimm_Ms4estdate = TO_DATE(?) , Juwimm_Milestone5 = (?) , Juwimm_Ms5planneddate = TO_DATE(?) , Ispaid = (?) , Isrecharge = (?) , Juwimm_Ms5estdate = TO_DATE(?) , Juwimm_Milestone6 = (?) , Juwimm_Ms6planneddate = TO_DATE(?) , BtnCopyTemplate = (?) , Subscriptionchangedate = TO_DATE(?) , Juwimm_Ms6estdate = TO_DATE(?) , Juwimm_Milestone7 = (?) , Juwimm_Ms7planneddate = TO_DATE(?) , Juwimm_Ms7estdate = TO_DATE(?) , Juwimm_Orderstatuscomplete_V_ID = (?) , Juwimm_Plannedend = TO_DATE(?) , Juwimm_Orderstatus_ID = (?) , Juwimm_Projectman = (?) , Juwimm_Estend = TO_DATE(?) , Juwimm_Ouputremarks = (?) , Juwimm_Lastaction = (?) , Juwimm_Nextaction = (?) , Juwimm_Issues = (?) , Juwimm_Decisions = (?) , Juwimm_Lastupdateon = TO_DATE(?) , Juwimm_Lastupdateby = (?) , IsActive = (?) , Posted = (?) , IsDelivered = (?) , C_Campaign_ID = (?) , IsTaxIncluded = (?) , DatePrinted = TO_DATE(?) , IsInvoiced = (?) , DateAcct = TO_DATE(?) , C_Order_ID = (?) , IsSelected = (?) , IsPrinted = (?) , IsSOTrx = (?) , C_Charge_ID = (?) , DocAction = (?) , C_Activity_ID = (?) , ChargeAmt = TO_NUMBER(?) , Processing = (?) , Processed = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_OrgTrx_ID, DropShip_User_ID, CopyFrom, DropShip_Location_ID, DropShip_BPartner_ID, IsSelfService, User2_ID, User1_ID, AD_Client_ID, AD_Org_ID, DocumentNo, Incotermsdescription, POReference, Generatetemplate, DateOrdered, Transactionreference, CopyFromPO, C_DocTypeTarget_ID, A_Asset_ID, Name, C_DocType_ID, DocStatus, Description, Deliverynotes, Internalnote, C_BPartner_ID, bpzipcode, BillTo_ID, C_BPartner_Location_ID, AD_User_ID, SalesRep_ID, M_PriceList_ID, IsDiscountPrinted, InvoiceRule, Estpropability, M_Warehouse_ID, C_Currency_ID, DeliveryRule, PriorityRule, PaymentRule, C_PaymentTerm_ID, C_Incoterms_ID, Delivery_Location_ID, DeliveryViaRule, M_Shipper_ID, Weight, Weight_Uom, FreightCostRule, M_Product_ID, Qty, FreightAmt, C_Project_ID, C_Projecttask_ID, Orderselfjoin, Firstschedinvoicedate, DatePromised, Scheddeliverydate, Schedtransactiondate, Transactiondate, Contractdate, Enddate, Invoicefrequence, C_Projectphase_ID, Isinvoiceafterfirstcycle, Quarterly_Month, Yearly_Month, C_Bidproject_ID, Weekly_Day, Monthly_Day, Proposalstatus, Lostproposalfixedreason, Lostproposalreason, Totallinesonetime, Grandtotalonetime, TotalLines, Generateproject, GrandTotal, Closeproject, Invoicedamt, Totalpaid, Completeordervalue, Deliverycomplete, Iscompletelyinvoiced, Juwimm_Completion, Juwimm_Time, Juwimm_Resources, Juwimm_Budget, Juwimm_Team_ID, Juwimm_Plannedgolive, Juwimm_Estgolive, Juwimm_Nextimpdate, Juwimm_Description, Juwimm_Plannedstart, Juwimm_Eststart, Juwimm_Milestone1, Juwimm_Ms1planneddate, Juwimm_Ms1estdate, Juwimm_Milestone2, Juwimm_Ms2planneddate, Juwimm_Ms2estdate, Juwimm_Milestone3, Juwimm_Ms3planneddate, Juwimm_Ms3estdate, Juwimm_Milestone4, Juwimm_Ms4planneddate, Juwimm_Ms4estdate, Juwimm_Milestone5, Juwimm_Ms5planneddate, Ispaid, Isrecharge, Juwimm_Ms5estdate, Juwimm_Milestone6, Juwimm_Ms6planneddate, BtnCopyTemplate, Subscriptionchangedate, Juwimm_Ms6estdate, Juwimm_Milestone7, Juwimm_Ms7planneddate, Juwimm_Ms7estdate, Juwimm_Orderstatuscomplete_V_ID, Juwimm_Plannedend, Juwimm_Orderstatus_ID, Juwimm_Projectman, Juwimm_Estend, Juwimm_Ouputremarks, Juwimm_Lastaction, Juwimm_Nextaction, Juwimm_Issues, Juwimm_Decisions, Juwimm_Lastupdateon, Juwimm_Lastupdateby, IsActive, Posted, IsDelivered, C_Campaign_ID, IsTaxIncluded, DatePrinted, IsInvoiced, DateAcct, C_Order_ID, IsSelected, IsPrinted, IsSOTrx, C_Charge_ID, DocAction, C_Activity_ID, ChargeAmt, Processing, Processed, created, createdby, updated, updatedBy)" +
