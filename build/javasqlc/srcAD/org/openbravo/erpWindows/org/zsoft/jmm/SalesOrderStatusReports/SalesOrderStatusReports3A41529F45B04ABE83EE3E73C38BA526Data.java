 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Juwimm_Orderstatus_Controlling_V_ID = (?) , Name = (?) , Project_Name = (?) , C_Order_ID = (?) , Documentno = (?) , Project_Value = (?) , Salesrep_ID = (?) , AD_Org_ID = (?) , C_Bpartner_ID = (?) , Isactive = (?) , Totallines = TO_NUMBER(?) , AD_User_ID = (?) , Juwimm_Completion = (?) , Juwimm_Time = (?) , IsSOTrx = (?) , Juwimm_Resources = (?) , Juwimm_Budget = (?) , Juwimm_Team_ID = (?) , Docstatus = (?) , Juwimm_Plannedgolive = TO_DATE(?) , Docaction = (?) , Juwimm_Estgolive = TO_DATE(?) , AD_Client_ID = (?) , Juwimm_Nextimpdate = TO_DATE(?) , C_Project_ID = (?) , Juwimm_Plannedstart = TO_DATE(?) , Juwimm_Eststart = TO_DATE(?) , Juwimm_Plannedend = TO_DATE(?) , Juwimm_Estend = TO_DATE(?) , Juwimm_Ouputremarks = (?) , Juwimm_Lastaction = (?) , Juwimm_Nextaction = (?) , Juwimm_Issues = (?) , Juwimm_Decisions = (?) , Iscompletelyinvoiced = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Juwimm_Orderstatus_Controlling_V_ID, Name, Project_Name, C_Order_ID, Documentno, Project_Value, Salesrep_ID, AD_Org_ID, C_Bpartner_ID, Isactive, Totallines, AD_User_ID, Juwimm_Completion, Juwimm_Time, IsSOTrx, Juwimm_Resources, Juwimm_Budget, Juwimm_Team_ID, Docstatus, Juwimm_Plannedgolive, Docaction, Juwimm_Estgolive, AD_Client_ID, Juwimm_Nextimpdate, C_Project_ID, Juwimm_Plannedstart, Juwimm_Eststart, Juwimm_Plannedend, Juwimm_Estend, Juwimm_Ouputremarks, Juwimm_Lastaction, Juwimm_Nextaction, Juwimm_Issues, Juwimm_Decisions, Iscompletelyinvoiced, created, createdby, updated, updatedBy)" +
