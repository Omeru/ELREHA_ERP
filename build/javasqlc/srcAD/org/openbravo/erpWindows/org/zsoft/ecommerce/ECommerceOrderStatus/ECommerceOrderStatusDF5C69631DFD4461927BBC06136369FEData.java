...
Create a registry
 */
  public static ECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[] set(String issotrx, String zseShoporderstatusId, String adClientId, String createdby, String createdbyr, String externalid, String updatedby, String updatedbyr, String adOrgId, String shopoderno, String isactive, String message, String status, String zseShopId, String cOrderId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET ZSE_Shop_ID = (?) , Shopoderno = (?) , C_Order_ID = (?) , Status = (?) , Message = (?) , Externalid = (?) , AD_Client_ID = (?) , Issotrx = (?) , Isactive = (?) , ZSE_Shoporderstatus_ID = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (ZSE_Shop_ID, Shopoderno, C_Order_ID, Status, Message, Externalid, AD_Client_ID, Issotrx, Isactive, ZSE_Shoporderstatus_ID, AD_Org_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
