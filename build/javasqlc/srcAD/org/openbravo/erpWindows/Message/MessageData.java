...
static Logger log4j = Logger.getLogger(MessageData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return msgtype;
    else if (fieldName.equalsIgnoreCase("msgtyper"))
      return msgtyper;
...
Select for edit
 */
  public static MessageData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static MessageData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        AND AD_Message.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND AD_Message.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectMessageData.adModuleId = UtilSql.getValue(result, "ad_module_id");
        objectMessageData.adModuleIdr = UtilSql.getValue(result, "ad_module_idr");
        objectMessageData.value = UtilSql.getValue(result, "value");
        objectMessageData.isactive = UtilSql.getValue(result, "isactive");
        objectMessageData.msgtype = UtilSql.getValue(result, "msgtype");
        objectMessageData.msgtyper = UtilSql.getValue(result, "msgtyper");
...
Create a registry
 */
  public static MessageData[] set(String adMessageId, String adModuleId, String msgtype, String msgtip, String isactive, String value, String adClientId, String updatedby, String updatedbyr, String adOrgId, String msgtext, String createdby, String createdbyr)    throws ServletException {
    ...
    objectMessageData[0].adModuleId = adModuleId;
    objectMessageData[0].adModuleIdr = "";
    objectMessageData[0].value = value;
    objectMessageData[0].isactive = isactive;
    objectMessageData[0].msgtype = msgtype;
    objectMessageData[0].msgtyper = "";
 ...
 */
  public static String selectDef5673D6C867390BBCE040007F01001CC2(ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef592_0(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef590_1(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, msgtype);
