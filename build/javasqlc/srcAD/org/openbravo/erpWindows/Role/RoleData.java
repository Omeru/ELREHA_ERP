...
Create a registry
 */
  public static RoleData[] set(String userlevel, String ismanual, String createdby, String createdbyr, String adClientId, String adOrgId, String theme, String orglist, String showinfomenu, String amtapproval, String name, String description, String isactive, String clientlist, String btnGeneraterole, String updatedby, String updatedbyr, String processing, String sessionexpiration, String adRoleId, String cCurrencyId, String adTreeMenuId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Role" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , Name = (?) , Description = (?) , IsActive = (?) , UserLevel = (?) , Showinfomenu = (?) , C_Currency_ID = (?) , AmtApproval = TO_NUMBER(?) , AD_Tree_Menu_ID = (?) , Sessionexpiration = TO_NUMBER(?) , Theme = (?) , btn_GenerateRole = (?) , Processing = (?) , IsManual = (?) , OrgList = (?) , ClientList = (?) , AD_Role_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO AD_Role " +
      "        (AD_Client_ID, AD_Org_ID, Name, Description, IsActive, UserLevel, Showinfomenu, C_Currency_ID, AmtApproval, AD_Tree_Menu_ID, Sessionexpiration, Theme, btn_GenerateRole, Processing, IsManual, OrgList, ClientList, AD_Role_ID, created, createdby, updated, updatedBy)" +
