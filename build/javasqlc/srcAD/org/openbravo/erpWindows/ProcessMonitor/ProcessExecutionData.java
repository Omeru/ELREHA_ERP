...
Create a registry
 */
  public static ProcessExecutionData[] set(String isactive, String status, String adUserId, String adProcessId, String updatedby, String updatedbyr, String log, String isrolesecurity, String adProcessRunId, String endTime, String startTime, String report, String adProcessRequestId, String channel, String params, String result, String createdby, String createdbyr, String adClientId, String adOrgId, String runtime)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Process_Run_ID = (?) , AD_Org_ID = (?) , AD_Process_ID = (?) , Isactive = (?) , AD_User_ID = (?) , Start_Time = (?) , End_Time = (?) , Runtime = (?) , Status = (?) , Channel = (?) , Log = (?) , Result = (?) , AD_Process_Request_ID = (?) , Report = (?) , Params = (?) , Isrolesecurity = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Process_Run_ID, AD_Org_ID, AD_Process_ID, Isactive, AD_User_ID, Start_Time, End_Time, Runtime, Status, Channel, Log, Result, AD_Process_Request_ID, Report, Params, Isrolesecurity, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
