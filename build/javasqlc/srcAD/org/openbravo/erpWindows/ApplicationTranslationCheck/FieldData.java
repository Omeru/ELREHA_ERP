...
Select for edit
 */
  public static FieldData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static FieldData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adLanguage==null || adLanguage.equals(""))?"":"  AND AD_Field_Trl.AD_Language = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectFieldData.adFieldTrlId = UtilSql.getValue(result, "ad_field_trl_id");
        objectFieldData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectFieldData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
        objectFieldData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectFieldData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
        objectFieldData.adFieldVId = UtilSql.getValue(result, "ad_field_v_id");
        objectFieldData.adFieldVIdr = UtilSql.getValue(result, "ad_field_v_idr");
        objectFieldData.adLanguage = UtilSql.getValue(result, "ad_language");
        objectFieldData.adLanguager = UtilSql.getValue(result, "ad_languager");
        objectFieldData.isactive = UtilSql.getValue(result, "isactive");
        objectFieldData.istranslated = UtilSql.getValue(result, "istranslated");
        objectFieldData.name = UtilSql.getValue(result, "name");
        objectFieldData.description = UtilSql.getValue(result, "description");
        objectFieldData.help = UtilSql.getValue(result, "help");
...
Create a registry
 */
  public static FieldData[] set(String adLanguage, String name, String adFieldTrlId, String help, String isactive, String adOrgId, String adFieldVId, String istranslated, String description, String adClientId, String updatedby, String updatedbyr, String createdby, String createdbyr)    throws ServletException {
    FieldData objectFieldData[] = new FieldData[1];
    objectFieldData[0] = new FieldData();
    objectFieldData[0].created = "";
    ...
    objectFieldData[0].adFieldTrlId = adFieldTrlId;
    objectFieldData[0].adClientId = adClientId;
    objectFieldData[0].adClientIdr = "";
    objectFieldData[0].adOrgId = adOrgId;
    objectFieldData[0].adOrgIdr = "";
    objectFieldData[0].adFieldVId = adFieldVId;
    objectFieldData[0].adFieldVIdr = "";
    objectFieldData[0].adLanguage = adLanguage;
    objectFieldData[0].adLanguager = "";
    objectFieldData[0].isactive = isactive;
    objectFieldData[0].istranslated = istranslated;
    objectFieldData[0].name = name;
    objectFieldData[0].description = description;
    objectFieldData[0].help = help;
