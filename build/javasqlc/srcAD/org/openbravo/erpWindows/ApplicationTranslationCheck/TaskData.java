...
Select for edit
 */
  public static TaskData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static TaskData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adLanguage==null || adLanguage.equals(""))?"":"  AND AD_Task_Trl.AD_Language = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTaskData.adTaskTrlId = UtilSql.getValue(result, "ad_task_trl_id");
        ...
        objectTaskData.adTaskIdr = UtilSql.getValue(result, "ad_task_idr");
        objectTaskData.adLanguage = UtilSql.getValue(result, "ad_language");
        objectTaskData.adLanguager = UtilSql.getValue(result, "ad_languager");
        objectTaskData.isactive = UtilSql.getValue(result, "isactive");
        objectTaskData.istranslated = UtilSql.getValue(result, "istranslated");
...
Create a registry
 */
  public static TaskData[] set(String adLanguage, String description, String isactive, String name, String updatedby, String updatedbyr, String istranslated, String adClientId, String help, String createdby, String createdbyr, String adTaskId, String adOrgId, String adTaskTrlId)    throws ServletException {
    ...
    objectTaskData[0].adTaskTrlId = adTaskTrlId;
    ...
    objectTaskData[0].adTaskIdr = "";
    objectTaskData[0].adLanguage = adLanguage;
    objectTaskData[0].adLanguager = "";
    objectTaskData[0].isactive = isactive;
    objectTaskData[0].istranslated = istranslated;
 ...
 */
  public static String selectParentID(ConnectionProvider connectionProvider, String key)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT AD_Task_Trl.AD_Language AS NAME" +
      "        FROM AD_Task_Trl" +
