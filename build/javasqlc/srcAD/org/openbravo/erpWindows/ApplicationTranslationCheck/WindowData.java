...
Select for edit
 */
  public static WindowData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static WindowData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adLanguage==null || adLanguage.equals(""))?"":"  AND AD_Window_Trl.AD_Language = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWindowData.adWindowTrlId = UtilSql.getValue(result, "ad_window_trl_id");
        ...
        objectWindowData.adWindowIdr = UtilSql.getValue(result, "ad_window_idr");
        objectWindowData.adLanguage = UtilSql.getValue(result, "ad_language");
        objectWindowData.adLanguager = UtilSql.getValue(result, "ad_languager");
        objectWindowData.isactive = UtilSql.getValue(result, "isactive");
        objectWindowData.istranslated = UtilSql.getValue(result, "istranslated");
...
Create a registry
 */
  public static WindowData[] set(String adLanguage, String adWindowTrlId, String isactive, String istranslated, String updatedby, String updatedbyr, String createdby, String createdbyr, String adWindowId, String help, String adOrgId, String name, String adClientId, String description)    throws ServletException {
    ...
    objectWindowData[0].adWindowTrlId = adWindowTrlId;
    ...
    objectWindowData[0].adWindowIdr = "";
    objectWindowData[0].adLanguage = adLanguage;
    objectWindowData[0].adLanguager = "";
    objectWindowData[0].isactive = isactive;
    objectWindowData[0].istranslated = istranslated;
