 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Toolbar_ID = (?) , AD_Toolbaritems_ID = (?) , Seqno = TO_NUMBER(?) , AD_Client_ID = (?) , Message = (?) , AD_Org_ID = (?) , Codesnippet = (?) , Isactive = (?) , Toolbaritem = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_toolbaritems.AD_Toolbaritems_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Toolbar_ID, AD_Toolbaritems_ID, Seqno, AD_Client_ID, Message, AD_Org_ID, Codesnippet, Isactive, Toolbaritem, created, createdby, updated, updatedBy)" +
