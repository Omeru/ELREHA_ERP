...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adProcessId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adProcessId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adProcessId==null || adProcessId.equals(""))?"":"  AND AD_Process_Trl.AD_Process_ID = ?  ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTranslationData.adProcessTrlId = UtilSql.getValue(result, "ad_process_trl_id");
        ...
        objectTranslationData.adProcessId = UtilSql.getValue(result, "ad_process_id");
        objectTranslationData.adProcessIdr = UtilSql.getValue(result, "ad_process_idr");
...
Create a registry
 */
  public static TranslationData[] set(String adProcessId, String adClientId, String name, String updatedby, String updatedbyr, String description, String createdby, String createdbyr, String adOrgId, String adLanguage, String help, String adProcessTrlId, String isactive, String istranslated)    throws ServletException {
    ...
    objectTranslationData[0].adProcessTrlId = adProcessTrlId;
    ...
    objectTranslationData[0].adProcessId = adProcessId;
    objectTranslationData[0].adProcessIdr = "";
