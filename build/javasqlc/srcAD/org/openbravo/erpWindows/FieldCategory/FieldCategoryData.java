...
static Logger log4j = Logger.getLogger(FieldCategoryData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return name;
    else if (fieldName.equalsIgnoreCase("displayed"))
      return displayed;
...
Select for edit
 */
  public static FieldCategoryData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static FieldCategoryData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        AND AD_FieldGroup.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND AD_FieldGroup.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectFieldCategoryData.adModuleId = UtilSql.getValue(result, "ad_module_id");
        objectFieldCategoryData.adModuleIdr = UtilSql.getValue(result, "ad_module_idr");
        objectFieldCategoryData.name = UtilSql.getValue(result, "name");
        objectFieldCategoryData.displayed = UtilSql.getValue(result, "displayed");
...
Create a registry
 */
  public static FieldCategoryData[] set(String adOrgId, String updatedby, String updatedbyr, String adClientId, String adModuleId, String name, String isactive, String createdby, String createdbyr, String displayed, String adFieldgroupId)    throws ServletException {
    ...
    objectFieldCategoryData[0].adModuleId = adModuleId;
    objectFieldCategoryData[0].adModuleIdr = "";
    objectFieldCategoryData[0].name = name;
    objectFieldCategoryData[0].displayed = displayed;
 ...
 */
  public static String selectDef5383_0(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef5661EC317B603D0FE040007F01004528(ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef5381_1(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, displayed);
