  ...
  public static CalendarData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectCalendarData.adClientIdr = UtilSql.getValue(result, "ad_client_idr");
...
Create a registry
 */
  public static CalendarData[] set(String name, String createdby, String createdbyr, String updatedby, String updatedbyr, String adOrgId, String isactive, String adClientId, String cCalendarId, String description)    throws ServletException {
    ...
    objectCalendarData[0].adClientIdr = "";
