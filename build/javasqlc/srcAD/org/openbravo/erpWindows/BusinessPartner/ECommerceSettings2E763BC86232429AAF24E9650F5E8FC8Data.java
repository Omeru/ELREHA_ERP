...
Create a registry
 */
  public static ECommerceSettings2E763BC86232429AAF24E9650F5E8FC8Data[] set(String cBpartnerId, String bpartneridremote, String adClientId, String paymentmethod, String zseEcommercegrantId, String externalid, String updatedby, String updatedbyr, String zseShopId, String isactive, String createdby, String createdbyr, String cBpartnerIdr, String orgidremote, String adOrgId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Bpartner_ID = (?) , Isactive = (?) , ZSE_Shop_ID = (?) , Paymentmethod = (?) , Orgidremote = (?) , Bpartneridremote = (?) , Externalid = (?) , AD_Client_ID = (?) , ZSE_Ecommercegrant_ID = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zse_ecommercegrant.ZSE_Ecommercegrant_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Bpartner_ID, Isactive, ZSE_Shop_ID, Paymentmethod, Orgidremote, Bpartneridremote, Externalid, AD_Client_ID, ZSE_Ecommercegrant_ID, AD_Org_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
