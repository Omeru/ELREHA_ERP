...
Create a registry
 */
  public static ShipmentRouteData[] set(String cBpartnerId, String adOrgId, String mWarehouseId, String createdby, String createdbyr, String adClientId, String updatedby, String updatedbyr, String mWarehouseShipperId, String isactive, String seqno, String cBpartnerIdr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET IsActive = (?) , M_Warehouse_Shipper_ID = (?) , AD_Client_ID = (?) , C_BPartner_ID = (?) , AD_Org_ID = (?) , M_Warehouse_ID = (?) , SeqNo = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE M_Warehouse_Shipper.M_Warehouse_Shipper_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (IsActive, M_Warehouse_Shipper_ID, AD_Client_ID, C_BPartner_ID, AD_Org_ID, M_Warehouse_ID, SeqNo, created, createdby, updated, updatedBy)" +
