...
static Logger log4j = Logger.getLogger(OrgSpecificData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return cBpartnerIdr;
    else if (fieldName.equalsIgnoreCase("c_bpartner_org_id") || fieldName.equals("cBpartnerOrgId"))
      return cBpartnerOrgId;
...
Select for edit
 */
  public static OrgSpecificData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static OrgSpecificData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((cBpartnerId==null || cBpartnerId.equals(""))?"":"  AND c_bpartner_org.C_Bpartner_ID = ?  ");
    strSql = strSql + 
      "        AND c_bpartner_org.C_Bpartner_Org_ID = ? " +
      "        AND c_bpartner_org.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND c_bpartner_org.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectOrgSpecificData.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
        objectOrgSpecificData.cBpartnerIdr = UtilSql.getValue(result, "c_bpartner_idr");
        objectOrgSpecificData.cBpartnerOrgId = UtilSql.getValue(result, "c_bpartner_org_id");
        ...
        objectOrgSpecificData.owncodeatpartnersite = UtilSql.getValue(result, "owncodeatpartnersite");
...
Create a registry
 */
  public static OrgSpecificData[] set(String cBpartnerId, String cBpartnerIdr, String isactive, String cBpartnerOrgId, String adClientId, String updatedby, String updatedbyr, String owncodeatpartnersite, String createdby, String createdbyr, String adOrgId)    throws ServletException {
    ...
    objectOrgSpecificData[0].cBpartnerId = cBpartnerId;
    objectOrgSpecificData[0].cBpartnerIdr = cBpartnerIdr;
    objectOrgSpecificData[0].cBpartnerOrgId = cBpartnerOrgId;
    objectOrgSpecificData[0].adOrgId = adOrgId;
    objectOrgSpecificData[0].adOrgIdr = "";
    objectOrgSpecificData[0].adClientId = adClientId;
    objectOrgSpecificData[0].owncodeatpartnersite = owncodeatpartnersite;
 ...
 */
  public static String selectDef2F0C180004AB4DD4BB12C189F5FD66CA_0(ConnectionProvider connectionProvider, String C_Bpartner_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef7A17EC9254EF4B1E854031D26C22096C_1(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef9E31BC2375DE4D5C98F2A11E7568207B_2(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cBpartnerId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cBpartnerOrgId);
