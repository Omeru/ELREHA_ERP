...
static Logger log4j = Logger.getLogger(BankAccountData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return aName;
    else if (fieldName.equalsIgnoreCase("mndtident"))
      return mndtident;
    else if (fieldName.equalsIgnoreCase("dtofsgntr"))
      return dtofsgntr;
 ...
 */
  public static BankAccountData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_BP_BankAccount.MndtIdent, " +
      "C_BP_BankAccount.Dtofsgntr, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBankAccountData.mndtident = UtilSql.getValue(result, "mndtident");
        objectBankAccountData.dtofsgntr = UtilSql.getDateValue(result, "dtofsgntr", "dd-MM-yyyy");
...
Create a registry
 */
  public static BankAccountData[] set(String cBpartnerId, String creditcardtype, String aStreet, String displayedaccount, String aEmail, String aZip, String adOrgId, String creditcardexpyy, String creditcardexpmm, String aName, String creditcardnumber, String bankName, String swiftcode, String showiban, String accountno, String rAvszip, String adClientId, String aState, String isactive, String routingno, String updatedby, String updatedbyr, String cBpBankaccountId, String cCountryId, String showaccountno, String aCountry, String iban, String createdby, String createdbyr, String aCity, String mndtident, String cBpartnerIdr, String created, String adUserId, String bankaccounttype, String dtofsgntr, String aIdentDl, String aIdentSsn)    throws ServletException {
    ...
    objectBankAccountData[0].mndtident = mndtident;
    objectBankAccountData[0].dtofsgntr = dtofsgntr;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET A_Country = (?) , RoutingNo = (?) , C_BPartner_ID = (?) , AD_User_ID = (?) , IsActive = (?) , AccountNo = (?) , ShowAccountNo = (?) , A_Zip = (?) , Iban = (?) , Showiban = (?) , SwiftCode = (?) , C_Country_ID = (?) , Displayedaccount = (?) , Bank_Name = (?) , A_Name = (?) , MndtIdent = (?) , Dtofsgntr = TO_DATE(?) , A_Ident_SSN = (?) , A_Ident_DL = (?) , A_State = (?) , A_Street = (?) , A_EMail = (?) , BankAccountType = (?) , A_City = (?) , CreditCardExpMM = TO_NUMBER(?) , CreditCardExpYY = TO_NUMBER(?) , CreditCardNumber = (?) , CreditCardType = (?) , R_AvsZip = (?) , C_BP_BankAccount_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BP_BankAccount.C_BP_BankAccount_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, mndtident);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, dtofsgntr);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (A_Country, RoutingNo, C_BPartner_ID, AD_User_ID, IsActive, AccountNo, ShowAccountNo, A_Zip, Iban, Showiban, SwiftCode, C_Country_ID, Displayedaccount, Bank_Name, A_Name, MndtIdent, Dtofsgntr, A_Ident_DL, A_Ident_SSN, A_EMail, A_State, A_Street, A_City, BankAccountType, C_BP_BankAccount_ID, CreditCardExpMM, CreditCardExpYY, CreditCardNumber, CreditCardType, R_AvsZip, AD_Org_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
