...
class ProductSalesData implements FieldProvider {
static Logger log4j = Logger.getLogger(ProductSalesData.class);
  ...
  public static ProductSalesData[] select(ConnectionProvider connectionProvider, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    return select(connectionProvider, rownum, key, name, warehouse, production, adRoleId, cBpartnerId, mProductCategoryId, vendorproductno, TypeOfProduct, adUserClient, orderBy, pgLimit, oraLimit1, oraLimit2, 0, 0);
  }

  public static ProductSalesData[] select(ConnectionProvider connectionProvider, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT B.*," +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        ProductSalesData objectProductSalesData = new ProductSalesData();
        objectProductSalesData.rn1 = UtilSql.getValue(result, "rn1");
        objectProductSalesData.mProductId = UtilSql.getValue(result, "m_product_id");
        objectProductSalesData.discontinued = UtilSql.getValue(result, "discontinued");
        objectProductSalesData.value = UtilSql.getValue(result, "value");
        objectProductSalesData.name = UtilSql.getValue(result, "name");
        objectProductSalesData.nameHidden = UtilSql.getValue(result, "name_hidden");
        objectProductSalesData.qty = UtilSql.getValue(result, "qty");
        objectProductSalesData.qtyorder = UtilSql.getValue(result, "qtyorder");
        objectProductSalesData.attribute = UtilSql.getValue(result, "attribute");
        objectProductSalesData.whName = UtilSql.getValue(result, "wh_name");
        objectProductSalesData.locValue = UtilSql.getValue(result, "loc_value");
        objectProductSalesData.x = UtilSql.getValue(result, "x");
        objectProductSalesData.y = UtilSql.getValue(result, "y");
        objectProductSalesData.z = UtilSql.getValue(result, "z");
        objectProductSalesData.mAttributesetinstanceId = UtilSql.getValue(result, "m_attributesetinstance_id");
        objectProductSalesData.mLocatorId = UtilSql.getValue(result, "m_locator_id");
        objectProductSalesData.cUom1Id = UtilSql.getValue(result, "c_uom1_id");
        objectProductSalesData.cUom2Id = UtilSql.getValue(result, "c_uom2_id");
        objectProductSalesData.preqtyonhand = UtilSql.getValue(result, "preqtyonhand");
        objectProductSalesData.preqtyorderonhand = UtilSql.getValue(result, "preqtyorderonhand");
        objectProductSalesData.locator = UtilSql.getValue(result, "locator");
        objectProductSalesData.cUom1 = UtilSql.getValue(result, "c_uom1");
        objectProductSalesData.cUom2 = UtilSql.getValue(result, "c_uom2");
        objectProductSalesData.qtyRef = UtilSql.getValue(result, "qty_ref");
        objectProductSalesData.quantityorderRef = UtilSql.getValue(result, "quantityorder_ref");
        objectProductSalesData.servidoBinary = UtilSql.getValue(result, "servido_binary");
        objectProductSalesData.position = Long.toString(countRecord);
        objectProductSalesData.rowkey = "";
        objectProductSalesData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectProductSalesData);
    ...
    ProductSalesData objectProductSalesData[] = new ProductSalesData[vector.size()];
    vector.copyInto(objectProductSalesData);
    return(objectProductSalesData);
  }

  public static ProductSalesData[] set()    throws ServletException {
    ProductSalesData objectProductSalesData[] = new ProductSalesData[1];
    objectProductSalesData[0] = new ProductSalesData();
    objectProductSalesData[0].rn1 = "";
    objectProductSalesData[0].mProductId = "";
    objectProductSalesData[0].discontinued = "";
    objectProductSalesData[0].value = "";
    objectProductSalesData[0].name = "";
    objectProductSalesData[0].nameHidden = "";
    objectProductSalesData[0].qty = "";
    objectProductSalesData[0].qtyorder = "";
    objectProductSalesData[0].attribute = "";
    objectProductSalesData[0].whName = "";
    objectProductSalesData[0].locValue = "";
    objectProductSalesData[0].x = "";
    objectProductSalesData[0].y = "";
    objectProductSalesData[0].z = "";
    objectProductSalesData[0].mAttributesetinstanceId = "";
    objectProductSalesData[0].mLocatorId = "";
    objectProductSalesData[0].cUom1Id = "";
    objectProductSalesData[0].cUom2Id = "";
    objectProductSalesData[0].preqtyonhand = "";
    objectProductSalesData[0].preqtyorderonhand = "";
    objectProductSalesData[0].locator = "";
    objectProductSalesData[0].cUom1 = "";
    objectProductSalesData[0].cUom2 = "";
    objectProductSalesData[0].qtyRef = "";
    objectProductSalesData[0].quantityorderRef = "";
    objectProductSalesData[0].servidoBinary = "";
    return objectProductSalesData;
  }

  public static String countRows(ConnectionProvider connectionProvider, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ProductSalesData[] selecttrl(ConnectionProvider connectionProvider, String adLanguage, String mWarehouse, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    return selecttrl(connectionProvider, adLanguage, mWarehouse, rownum, key, name, warehouse, production, adRoleId, cBpartnerId, mProductCategoryId, vendorproductno, TypeOfProduct, adUserClient, orderBy, pgLimit, oraLimit1, oraLimit2, 0, 0);
  }
  ...
  public static ProductSalesData[] selecttrl(ConnectionProvider connectionProvider, String adLanguage, String mWarehouse, String rownum, String key, String name, String warehouse, String production, String adRoleId, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductSalesData.qtyRef = UtilSql.getValue(result, "qty_ref");
        objectProductSalesData.quantityorderRef = UtilSql.getValue(result, "quantityorder_ref");
        objectProductSalesData.rowkey = UtilSql.getValue(result, "rowkey");
        objectProductSalesData.locator = UtilSql.getValue(result, "locator");
        objectProductSalesData.cUom1 = UtilSql.getValue(result, "c_uom1");
        objectProductSalesData.cUom2 = UtilSql.getValue(result, "c_uom2");
        objectProductSalesData.servidoBinary = UtilSql.getValue(result, "servido_binary");
  ...
  public static String countRowsNotStored(ConnectionProvider connectionProvider, String rownum, String key, String name, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String adUserOrg, String production, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT COUNT(*) as VALUE FROM ( SELECT ";
    strSql = strSql + ((rownum==null || rownum.equals(""))?"":rownum);
  ...
  public static ProductSalesData[] selectNotStored(ConnectionProvider connectionProvider, String rownum, String key, String name, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    return selectNotStored(connectionProvider, rownum, key, name, cBpartnerId, mProductCategoryId, vendorproductno, TypeOfProduct, adUserClient, adUserOrg, production, orderBy, pgLimit, oraLimit1, oraLimit2, 0, 0);
  }

  public static ProductSalesData[] selectNotStored(ConnectionProvider connectionProvider, String rownum, String key, String name, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT B.*," +
  ...
  public static ProductSalesData[] selectNotStoredtrl(ConnectionProvider connectionProvider, String rownum, String adLanguage, String key, String name, String cBpartnerId, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String adUserClient, String adUserOrg, String production, String orderBy, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    return selectNotStoredtrl(connectionProvider, rownum, adLanguage, key, name, cBpartnerId, mProductCategoryId, vendorproductno, TypeOfProduct, adUserClient, adUserOrg, production, orderBy, pgLimit, oraLimit1, oraLimit2, 0, 0);
  }
