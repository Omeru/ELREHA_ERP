...
String strParamMovementQty_f = vars.getSessionValue(tabId + "|paramMovementQty_f");
    ...
    if (vars.getSessionValue(windowId +  "|M_Movement_ID").isEmpty()) vars.setSessionValue(windowId + "|M_Movement_ID", vars.getStringParameter("inpmMovementId"));
