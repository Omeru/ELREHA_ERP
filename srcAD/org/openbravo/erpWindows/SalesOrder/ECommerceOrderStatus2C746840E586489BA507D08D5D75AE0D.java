...
public class ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.class);
  
  private static final String windowId = "143";
  private static final String tabId = "2C746840E586489BA507D08D5D75AE0D";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.view", "EDIT");

        printPageEdit(response, request, vars, false, strZSE_Shoporderstatus_ID, strPC_Order_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamC_Order_ID", tabId + "|paramC_Order_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strZSE_Shoporderstatus_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");
      ...
      vars.setSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|ZSE_Shoporderstatus_ID");
      vars.setSessionValue(windowId + "|C_Order_ID", strPC_Order_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strZSE_Shoporderstatus_ID = vars.getRequiredStringParameter("inpzseShoporderstatusId");
      //ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData data = getEditVariables(vars, strPC_Order_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.delete(this, strZSE_Shoporderstatus_ID, strPC_Order_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strZSE_Shoporderstatus_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.deleteTransactional(conn, this, strKey, strPC_Order_ID)==0) {
...
*/
  private ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
    ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData data = new ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData();
    ServletException ex = null;
    try {
    data.cOrderId = vars.getStringParameter("inpcOrderId");     data.cOrderIdr = vars.getStringParameter("inpcOrderId_R");     data.zseShopId = vars.getStringParameter("inpzseShopId");     data.zseShopIdr = vars.getStringParameter("inpzseShopId_R");     data.status = vars.getStringParameter("inpstatus");     data.statusr = vars.getStringParameter("inpstatus_R");     data.shopoderno = vars.getStringParameter("inpshopoderno");     data.externalid = vars.getStringParameter("inpexternalid");     data.datedelivered = vars.getStringParameter("inpdatedelivered");     data.shipper = vars.getStringParameter("inpshipper");     data.trackingno = vars.getStringParameter("inptrackingno");     data.message = vars.getStringParameter("inpmessage");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.zseShoporderstatusId = vars.getRequestGlobalVariable("inpzseShoporderstatusId", windowId + "|ZSE_Shoporderstatus_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.issotrx = vars.getStringParameter("inpissotrx", "N"); 
  ...
  private String getParentID(VariablesSecureApp vars, String strZSE_Shoporderstatus_ID) throws ServletException {
    String strPC_Order_ID = ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectParentID(this, strZSE_Shoporderstatus_ID);
    if (strPC_Order_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|ZSE_Shoporderstatus_ID", data[0].getField("zseShoporderstatusId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
      ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData[] data = ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Order_ID, vars.getStringParameter("inpzseShoporderstatusId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPC_Order_ID, String strZSE_Shoporderstatus_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesOrder/ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D", false, "document.frmMain.inpzseShoporderstatusId", "grid", "..", "".equals("Y"), "SalesOrder", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D_Relation.html", "SalesOrder", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectParent(this, strPC_Order_ID));
    else xmlDocument.setParameter("parent", ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectParentTrl(this, strPC_Order_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZSE_Shoporderstatus_ID, String strPC_Order_ID, TableSQLData tableSQL)
    ...
    ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Order_ID, strZSE_Shoporderstatus_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.set(strPC_Order_ID, Utility.getDefault(this, vars, "Issotrx", "Y", "143", "2C746840E586489BA507D08D5D75AE0D", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), "", Utility.getDefault(this, vars, "Createdby", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectDef05E4F0D6DB1F4BDFB370BCE936346934_0(this, Utility.getDefault(this, vars, "Createdby", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField)), Utility.getDefault(this, vars, "Shipper", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "Externalid", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "Trackingno", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.selectDefA80A1F8192FC4B84A56DE233AFBB6453_1(this, Utility.getDefault(this, vars, "Updatedby", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField)), Utility.getDefault(this, vars, "Shopoderno", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), "Y", Utility.getDefault(this, vars, "Message", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "Status", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "ZSE_Shop_ID", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField), Utility.getDefault(this, vars, "Datedelivered", "", "143", "2C746840E586489BA507D08D5D75AE0D", "", dataField));
        
      }
    } else {
      data = new ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzseShoporderstatusId", "", "..", "".equals("Y"), "SalesOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZSE_Shoporderstatus_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0DData.getCurrentDBTimestamp(this, data.zseShoporderstatusId).equals(
  ...
  public String getServletInfo() {
    return "Servlet ECommerceOrderStatus2C746840E586489BA507D08D5D75AE0D. This Servlet was made by Wad constructor";
