...
*/
  private BusinessPartnerData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Offer_ID) throws IOException,ServletException {
    ...
    try {
    data.mOfferId = vars.getStringParameter("inpmOfferId");     data.mOfferIdr = vars.getStringParameter("inpmOfferId_R");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.mOfferBpartnerId = vars.getRequestGlobalVariable("inpmOfferBpartnerId", windowId + "|M_Offer_Bpartner_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.isactive = vars.getStringParameter("inpisactive", "N"); 
   ...
   private BusinessPartnerData[] getRelationData(BusinessPartnerData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].mOfferBpartnerId = FormatUtilities.truncate(data[i].mOfferBpartnerId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);}
    }
    return data;
  }
