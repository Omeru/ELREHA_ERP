...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strSNR_Serialnumbertracking_ID) throws ServletException {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPSNR_Batchmasterdata_ID) throws IOException,ServletException {
      BatchNumberTransactionsData[] data = BatchNumberTransactionsData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPSNR_Batchmasterdata_ID, vars.getStringParameter("inpsnrSerialnumbertrackingId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = BatchNumberTransactionsData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPSNR_Batchmasterdata_ID, strSNR_Serialnumbertracking_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
