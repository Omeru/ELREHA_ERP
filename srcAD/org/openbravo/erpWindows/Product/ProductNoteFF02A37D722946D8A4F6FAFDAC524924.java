...
public class ProductNoteFF02A37D722946D8A4F6FAFDAC524924 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(ProductNoteFF02A37D722946D8A4F6FAFDAC524924.class);
  
  private static final String windowId = "140";
  private static final String tabId = "FF02A37D722946D8A4F6FAFDAC524924";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.view", "EDIT");

        printPageEdit(response, request, vars, false, strElrs_Product_Notes_ID, strPM_Product_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamName", tabId + "|paramName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strElrs_Product_Notes_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");
      ...
      vars.setSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|ProductNoteFF02A37D722946D8A4F6FAFDAC524924.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|Elrs_Product_Notes_ID");
      vars.setSessionValue(windowId + "|M_Product_ID", strPM_Product_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strElrs_Product_Notes_ID = vars.getRequiredInStringParameter("inpelrsProductNotesId");
      String message = deleteRelation(vars, strElrs_Product_Notes_ID, strPM_Product_ID);
      if (!message.equals("")) {
      ...
      String strElrs_Product_Notes_ID = vars.getRequiredStringParameter("inpelrsProductNotesId");
      //ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data data = getEditVariables(vars, strPM_Product_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.delete(this, strElrs_Product_Notes_ID, strPM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
/*
  String deleteRelation(VariablesSecureApp vars, String strElrs_Product_Notes_ID, String strPM_Product_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strElrs_Product_Notes_ID.startsWith("(")) strElrs_Product_Notes_ID = strElrs_Product_Notes_ID.substring(1, strElrs_Product_Notes_ID.length()-1);
      if (!strElrs_Product_Notes_ID.equals("")) {
        strElrs_Product_Notes_ID = Replace.replace(strElrs_Product_Notes_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strElrs_Product_Notes_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.deleteTransactional(conn, this, strKey, strPM_Product_ID)==0) {
...
*/
  private ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
    ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data data = new ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data();
   ...
   private ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data[] getRelationData(ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strElrs_Product_Notes_ID) throws ServletException {
    String strPM_Product_ID = ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectParentID(this, strElrs_Product_Notes_ID);
    if (strPM_Product_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
      ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data[] data = ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "m_product_id", windowId), strPM_Product_ID, vars.getStringParameter("inpelrsProductNotesId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPM_Product_ID, String strElrs_Product_Notes_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Product/ProductNoteFF02A37D722946D8A4F6FAFDAC524924_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ProductNoteFF02A37D722946D8A4F6FAFDAC524924", false, "document.frmMain.inpelrsProductNotesId", "grid", "..", "".equals("Y"), "Product", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ProductNoteFF02A37D722946D8A4F6FAFDAC524924_Relation.html", "Product", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ProductNoteFF02A37D722946D8A4F6FAFDAC524924_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectParent(this, vars.getLanguage(), strPM_Product_ID));
    else xmlDocument.setParameter("parent", ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectParentTrl(this, vars.getLanguage(), strPM_Product_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strElrs_Product_Notes_ID, String strPM_Product_ID, TableSQLData tableSQL)
    ...
    ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "m_product_id", windowId), strPM_Product_ID, strElrs_Product_Notes_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.set(strPM_Product_ID, Utility.getDefault(this, vars, "Updatedby", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField), ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectDef9076595CD84249A0BF882CEBFD332248_0(this, Utility.getDefault(this, vars, "Updatedby", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField), ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectDefB74AB8092EA74EC0920BEF2B7C53029C_1(this, Utility.getDefault(this, vars, "Createdby", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField)), ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.selectDefCAA78B52F91F43EDA536E18569583A31_2(this, strPM_Product_ID), Utility.getDefault(this, vars, "Name", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField), Utility.getDefault(this, vars, "Value", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField), "Y", Utility.getDefault(this, vars, "Note", "", "140", "FF02A37D722946D8A4F6FAFDAC524924", "", dataField));
        
      }
    } else {
      data = new ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "ProductNoteFF02A37D722946D8A4F6FAFDAC524924", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpelrsProductNotesId", "", "..", "".equals("Y"), "Product", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strElrs_Product_Notes_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (ProductNoteFF02A37D722946D8A4F6FAFDAC524924Data.getCurrentDBTimestamp(this, data.elrsProductNotesId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.elrsProductNotesId, vars, this);
        } catch(Exception ex) {
  ...
  public String getServletInfo() {
    return "Servlet ProductNoteFF02A37D722946D8A4F6FAFDAC524924. This Servlet was made by Wad constructor";
