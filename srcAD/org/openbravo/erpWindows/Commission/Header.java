   ...
   private HeaderData[] getRelationData(HeaderData[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_Commission_ID", data[0].getField("cCommissionId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Commission_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Shareofturnoverpartner", "", "207", "355", "", dataField), "", Utility.getDefault(this, vars, "ListDetails", "", "207", "355", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "207", "355", "", dataField), HeaderData.selectDef5674_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "207", "355", "", dataField)), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "207", "355", "", dataField), Utility.getDefault(this, vars, "DateLastRun", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "207", "355", "", dataField), HeaderData.selectDef802829_1(this, Utility.getDefault(this, vars, "M_Product_ID", "", "207", "355", "", dataField)), Utility.getDefault(this, vars, "Shareofturnoverpercent", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "Name", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "Processing", "", "207", "355", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "207", "355", "", dataField), HeaderData.selectDef5672_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "207", "355", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_ID", "", "207", "355", "", dataField), HeaderData.selectDef5677_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "207", "355", "", dataField)), Utility.getDefault(this, vars, "DocBasisType", "I", "207", "355", "", dataField), Utility.getDefault(this, vars, "FrequencyType", "M", "207", "355", "", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "207", "355", "N", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "207", "355", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "207", "355", "", dataField), Utility.getDefault(this, vars, "Description", "", "207", "355", "", dataField));
