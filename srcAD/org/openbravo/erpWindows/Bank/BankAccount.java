...
*/
  private BankAccountData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Bank_ID) throws IOException,ServletException {
   ...
   private BankAccountData[] getRelationData(BankAccountData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].digitcontrol = FormatUtilities.truncate(data[i].digitcontrol, 1);        data[i].codeaccount = FormatUtilities.truncate(data[i].codeaccount, 10);        data[i].accountno = FormatUtilities.truncate(data[i].accountno, 20);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cBankId = FormatUtilities.truncate(data[i].cBankId, 44);        data[i].bankaccounttype = FormatUtilities.truncate(data[i].bankaccounttype, 21);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 44);        data[i].genericaccount = FormatUtilities.truncate(data[i].genericaccount, 50);        data[i].iban = FormatUtilities.truncate(data[i].iban, 34);        data[i].displayedaccount = FormatUtilities.truncate(data[i].displayedaccount, 26);        data[i].cdtrschmeident = FormatUtilities.truncate(data[i].cdtrschmeident, 15);        data[i].cBankaccountId = FormatUtilities.truncate(data[i].cBankaccountId, 10);}
    }
    return data;
  }
...
String strParamC_Currency_ID = vars.getSessionValue(tabId + "|paramC_Currency_ID");
    ...
    if (vars.getSessionValue(windowId +  "|C_Bank_ID").isEmpty()) vars.setSessionValue(windowId + "|C_Bank_ID", vars.getStringParameter("inpcBankId"));
    boolean hasSearchCondition=false;
    vars.removeEditionData(tabId);
    if (!(strParamDisplayedAccount.equals("") && strParamC_Currency_ID.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
...
String strParamC_Currency_ID = vars.getSessionValue(tabId + "|paramC_Currency_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = BankAccountData.set(strPC_Bank_ID, Utility.getDefault(this, vars, "CurrentBalance", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "AccountNo", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "Codeaccount", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "Digitcontrol", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "GenericAccount", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "Iban", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "CdtrSchmeIdent", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "ShowIBAN", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "158", "228", "", dataField), Utility.getDefault(this, vars, "IsDefault", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "158", "228", "", dataField), BankAccountData.selectDef3071_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "158", "228", "", dataField)), Utility.getDefault(this, vars, "Created", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "ShowGeneric", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "ShowSpanish", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "CreditLimit", "", "158", "228", "", dataField), "Y", Utility.getDefault(this, vars, "BankAccountType", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "DisplayedAccount", "", "158", "228", "", dataField), "", Utility.getDefault(this, vars, "CreatedBy", "", "158", "228", "", dataField), BankAccountData.selectDef3069_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "158", "228", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "158", "228", "", dataField));
