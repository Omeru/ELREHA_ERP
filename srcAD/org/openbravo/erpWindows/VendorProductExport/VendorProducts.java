...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strI_Product_Po_V_ID = vars.getRequiredInStringParameter("inpiProductPoVId");
      String message = deleteRelation(vars, strI_Product_Po_V_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strI_Product_Po_V_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strI_Product_Po_V_ID.startsWith("(")) strI_Product_Po_V_ID = strI_Product_Po_V_ID.substring(1, strI_Product_Po_V_ID.length()-1);
      if (!strI_Product_Po_V_ID.equals("")) {
        strI_Product_Po_V_ID = Replace.replace(strI_Product_Po_V_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strI_Product_Po_V_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (VendorProductsData.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private VendorProductsData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private VendorProductsData[] getRelationData(VendorProductsData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].value = FormatUtilities.truncate(data[i].value, 20);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 32);        data[i].upc = FormatUtilities.truncate(data[i].upc, 20);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 32);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 32);        data[i].vendorproductno = FormatUtilities.truncate(data[i].vendorproductno, 40);        data[i].vendorcategory = FormatUtilities.truncate(data[i].vendorcategory, 30);        data[i].mManufacturerId = FormatUtilities.truncate(data[i].mManufacturerId, 32);        data[i].manufacturernumber = FormatUtilities.truncate(data[i].manufacturernumber, 30);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].iProductPoVId = FormatUtilities.truncate(data[i].iProductPoVId, 50);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);}
    }
    return data;
  }
...
String strParamName = vars.getSessionValue(tabId + "|paramName");
    ...
    if (!(strParamValue.equals("") && strParamC_Bpartner_ID.equals("") && strParamName.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
...
String strParamName = vars.getSessionValue(tabId + "|paramName");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = VendorProductsData.set(Utility.getDefault(this, vars, "Upc", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), VendorProductsData.selectDef9AE86F823AC84EDBBFA7EE2F12FDCBAD_0(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField)), Utility.getDefault(this, vars, "M_Manufacturer_ID", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Pricelastinv", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Qtystd", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Vendorcategory", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Discontinuedby", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Order_Min", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Name", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Discontinued", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "N", dataField), Utility.getDefault(this, vars, "Deliverytime_Promised", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Qualityrating", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Value", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Ismultipleofminimumqty", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "N", dataField), Utility.getDefault(this, vars, "Createdby", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), VendorProductsData.selectDefE38DE16FBB1E4EBFA590FF8E366F3E04_1(this, Utility.getDefault(this, vars, "Createdby", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField)), "", Utility.getDefault(this, vars, "Updatedby", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), VendorProductsData.selectDefC08F4C1B28214F76B787B93595973300_2(this, Utility.getDefault(this, vars, "Updatedby", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField)), Utility.getDefault(this, vars, "Pricelastpo", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Manufacturernumber", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), "Y", Utility.getDefault(this, vars, "C_Currency_ID", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Pricepo", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Vendorproductno", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField), Utility.getDefault(this, vars, "Iscurrentvendor", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "N", dataField), Utility.getDefault(this, vars, "Pricelist", "", "12BEB7E4D0004D43808466C108446209", "34E4714B262B49BFA604E6697859F090", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
          ...
          CrudOperations.UpdateCustomFields(tabId, data.iProductPoVId, vars, this);
        } catch(Exception ex) {
