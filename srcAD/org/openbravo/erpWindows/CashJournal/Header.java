...
String strParamStatementDate_f = vars.getSessionValue(tabId + "|paramStatementDate_f");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Header", false, "document.frmMain.inpcCashId", "grid", "../cashbook/print.html", "N".equals("Y"), "CashJournal", strReplaceWith, false);
...
String strParamStatementDate_f = vars.getSessionValue(tabId + "|paramStatementDate_f");
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcCashId", "", "../cashbook/print.html", "N".equals("Y"), "CashJournal", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Cash_ID));
