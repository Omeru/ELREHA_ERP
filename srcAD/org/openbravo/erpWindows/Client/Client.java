...
*/
  private ClientData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private ClientData[] getRelationData(ClientData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].value = FormatUtilities.truncate(data[i].value, 20);        data[i].name = FormatUtilities.truncate(data[i].name, 20);        data[i].description = FormatUtilities.truncate(data[i].description, 30);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 8);        data[i].adLanguage = FormatUtilities.truncate(data[i].adLanguage, 20);        data[i].requestemail = FormatUtilities.truncate(data[i].requestemail, 30);        data[i].smtphost = FormatUtilities.truncate(data[i].smtphost, 30);        data[i].requestfolder = FormatUtilities.truncate(data[i].requestfolder, 20);        data[i].requestuser = FormatUtilities.truncate(data[i].requestuser, 20);        data[i].requestuserpw = FormatUtilities.truncate(data[i].requestuserpw, 30);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);}
    }
    return data;
  }
...
String strParamName = vars.getSessionValue(tabId + "|paramName");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ClientData.set(Utility.getDefault(this, vars, "Name", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "RequestEMail", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "Smtpport", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "requestuserpw", "", "109", "145", "", dataField), "0", Utility.getDefault(this, vars, "Description", "", "109", "145", "", dataField), "Y", Utility.getDefault(this, vars, "RequestFolder", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "109", "145", "", dataField), ClientData.selectDef621_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "109", "145", "", dataField)), Utility.getDefault(this, vars, "Usessl", "N", "109", "145", "N", dataField), "", Utility.getDefault(this, vars, "AD_Language", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "IsMultiLingualDocument", "", "109", "145", "N", dataField), Utility.getDefault(this, vars, "IsSmtpAuthorization", "N", "109", "145", "N", dataField), Utility.getDefault(this, vars, "Usetls", "N", "109", "145", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "0", "109", "145", "", dataField), ClientData.selectDef619_1(this, Utility.getDefault(this, vars, "CreatedBy", "0", "109", "145", "", dataField)), Utility.getDefault(this, vars, "Value", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "SMTPHost", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "RequestUser", "", "109", "145", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "109", "145", "", dataField));
