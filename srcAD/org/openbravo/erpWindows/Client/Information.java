...
*/
  private InformationData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private InformationData[] getRelationData(InformationData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 20);        data[i].adTreeOrgId = FormatUtilities.truncate(data[i].adTreeOrgId, 20);        data[i].adTreeMenuId = FormatUtilities.truncate(data[i].adTreeMenuId, 20);        data[i].adTreeBpartnerId = FormatUtilities.truncate(data[i].adTreeBpartnerId, 20);        data[i].adTreeProductId = FormatUtilities.truncate(data[i].adTreeProductId, 20);        data[i].adTreeProjectId = FormatUtilities.truncate(data[i].adTreeProjectId, 20);        data[i].adTreeSalesregionId = FormatUtilities.truncate(data[i].adTreeSalesregionId, 20);        data[i].yourCompanyBigImage = FormatUtilities.truncate(data[i].yourCompanyBigImage, 10);        data[i].yourCompanyDocumentImage = FormatUtilities.truncate(data[i].yourCompanyDocumentImage, 10);        data[i].yourCompanyMenuImage = FormatUtilities.truncate(data[i].yourCompanyMenuImage, 32);        data[i].cCalendarId = FormatUtilities.truncate(data[i].cCalendarId, 20);        data[i].mProductfreightId = FormatUtilities.truncate(data[i].mProductfreightId, 20);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 20);        data[i].cBpartnercashtrxId = FormatUtilities.truncate(data[i].cBpartnercashtrxId, 20);        data[i].cUomTimeId = FormatUtilities.truncate(data[i].cUomTimeId, 10);        data[i].cUomLengthId = FormatUtilities.truncate(data[i].cUomLengthId, 10);        data[i].cUomWeightId = FormatUtilities.truncate(data[i].cUomWeightId, 10);        data[i].cAcctschema1Id = FormatUtilities.truncate(data[i].cAcctschema1Id, 44);        data[i].cAcctschema2Id = FormatUtilities.truncate(data[i].cAcctschema2Id, 44);        data[i].cAcctschema3Id = FormatUtilities.truncate(data[i].cAcctschema3Id, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cUomVolumeId = FormatUtilities.truncate(data[i].cUomVolumeId, 10);}
    }
    return data;
  }
