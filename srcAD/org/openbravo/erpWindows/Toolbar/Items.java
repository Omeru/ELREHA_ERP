...
*/
  private ItemsData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Toolbar_ID) throws IOException,ServletException {
    ...
    try {
    data.adToolbarId = vars.getStringParameter("inpadToolbarId");     data.adToolbarIdr = vars.getStringParameter("inpadToolbarId_R");     data.adToolbaritemsId = vars.getRequestGlobalVariable("inpadToolbaritemsId", windowId + "|AD_Toolbaritems_ID");    try {   data.seqno = vars.getNumericParameter("inpseqno");  } catch (ServletException paramEx) { ex = paramEx; }     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.message = vars.getStringParameter("inpmessage");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.codesnippet = vars.getStringParameter("inpcodesnippet");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.toolbaritem = vars.getStringParameter("inptoolbaritem");     data.toolbaritemr = vars.getStringParameter("inptoolbaritem_R"); 
