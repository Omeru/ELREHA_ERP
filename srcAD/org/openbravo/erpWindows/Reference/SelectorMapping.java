...
String strParamMappingName = vars.getSessionValue(tabId + "|paramMappingName");
    ...
    if (vars.getSessionValue(windowId +  "|AD_Model_Object_ID").isEmpty()) vars.setSessionValue(windowId + "|AD_Model_Object_ID", vars.getStringParameter("inpadModelObjectId"));
