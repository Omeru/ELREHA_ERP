...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Requisitionline_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|M_Product_ID", data[0].getField("mProductId"));    vars.setSessionValue(windowId + "|M_Requisitionline_ID", data[0].getField("mRequisitionlineId"));
    }
...
String strParamNeedbydate_f = vars.getSessionValue(tabId + "|paramNeedbydate_f");
    ...
    if (vars.getSessionValue(windowId +  "|M_Requisition_ID").isEmpty()) vars.setSessionValue(windowId + "|M_Requisition_ID", vars.getStringParameter("inpmRequisitionId"));
