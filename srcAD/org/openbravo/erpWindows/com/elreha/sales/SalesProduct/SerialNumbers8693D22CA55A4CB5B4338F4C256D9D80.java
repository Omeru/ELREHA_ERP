...
public class SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "8693D22CA55A4CB5B4338F4C256D9D80";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.view", "EDIT");

        printPageEdit(response, request, vars, false, strSNR_Masterdata_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamGuaranteedate_f", tabId + "|paramGuaranteedate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strSNR_Masterdata_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|SNR_Masterdata_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strSNR_Masterdata_ID = vars.getRequiredStringParameter("inpsnrMasterdataId");
      //SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.delete(this, strSNR_Masterdata_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strSNR_Masterdata_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.deleteTransactional(conn, this, strKey)==0) {
   ...
   private SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data[] getRelationData(SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|SNR_Masterdata_ID", data[0].getField("snrMasterdataId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|Serialnumber", data[0].getField("serialnumber"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data[] data = SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "M_PRODUCT_ID", windowId), vars.getStringParameter("inpsnrMasterdataId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80", false, "document.frmMain.inpsnrMasterdataId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strSNR_Masterdata_ID, TableSQLData tableSQL)
    ...
    SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data[] data=null;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "M_PRODUCT_ID", windowId), strSNR_Masterdata_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.set(Utility.getDefault(this, vars, "Orderreference", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_Location_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), "", Utility.getDefault(this, vars, "Createdby", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectDef317FB8A077064C76918AB109625DA981_0(this, Utility.getDefault(this, vars, "Createdby", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField)), Utility.getDefault(this, vars, "Description", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Firstseen", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Identifier2", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Externaltrackingno", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Movementdate", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Serialnumber", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "null", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectDef2C7D9CFB113B43898F40654356D3F22B_1(this, Utility.getDefault(this, vars, "M_Locator_ID", "null", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField)), Utility.getDefault(this, vars, "m_inventoryline_id", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Identifier3", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectDefEE5E955AF82E4EBB8CC343AA1BC17A2E_2(this, Utility.getDefault(this, vars, "M_Product_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField)), Utility.getDefault(this, vars, "Model", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Sendmail", "N", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "N", dataField), Utility.getDefault(this, vars, "Itemname", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "m_inoutline_id", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Snrselfjoin", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Movementtype", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Location", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectDef6CDD97D1255940789152D2FF953D5266_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField)), Utility.getDefault(this, vars, "m_movementline_id", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Guaranteedate", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "m_internal_consumptionline_id", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), "Y", Utility.getDefault(this, vars, "C_Projecttask_ID", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.selectDef882E0B7E4F8A43E6A5C5B886B0ABE8FD_4(this, Utility.getDefault(this, vars, "Updatedby", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField)), Utility.getDefault(this, vars, "Remark", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField), Utility.getDefault(this, vars, "Vendor", "", "6614375915A04200ACCE9C693F0651E2", "8693D22CA55A4CB5B4338F4C256D9D80", "", dataField));
        
      }
    } else {
      data = new SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpsnrMasterdataId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strSNR_Masterdata_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        ...
        strSkeleton=Replace.replace(strSkeleton,"ActionButton_Responser.html","SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80_Edition.html");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80Data.getCurrentDBTimestamp(this, data.snrMasterdataId).equals(
  ...
  public String getServletInfo() {
    return "Servlet SerialNumbers8693D22CA55A4CB5B4338F4C256D9D80. This Servlet was made by Wad constructor";
