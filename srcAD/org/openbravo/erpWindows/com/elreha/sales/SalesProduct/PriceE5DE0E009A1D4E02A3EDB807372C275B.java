...
public class PriceE5DE0E009A1D4E02A3EDB807372C275B extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(PriceE5DE0E009A1D4E02A3EDB807372C275B.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "E5DE0E009A1D4E02A3EDB807372C275B";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.view", "EDIT");

        printPageEdit(response, request, vars, false, strM_ProductPrice_ID, strPM_Product_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamM_PriceList_Version_ID", tabId + "|paramM_PriceList_Version_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_ProductPrice_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");
      ...
      vars.setSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|PriceE5DE0E009A1D4E02A3EDB807372C275B.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_ProductPrice_ID");
      vars.setSessionValue(windowId + "|M_Product_ID", strPM_Product_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strM_ProductPrice_ID = vars.getRequiredStringParameter("inpmProductpriceId");
      //PriceE5DE0E009A1D4E02A3EDB807372C275BData data = getEditVariables(vars, strPM_Product_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = PriceE5DE0E009A1D4E02A3EDB807372C275BData.delete(this, strM_ProductPrice_ID, strPM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strM_ProductPrice_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PriceE5DE0E009A1D4E02A3EDB807372C275BData.deleteTransactional(conn, this, strKey, strPM_Product_ID)==0) {
...
*/
  private PriceE5DE0E009A1D4E02A3EDB807372C275BData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
    PriceE5DE0E009A1D4E02A3EDB807372C275BData data = new PriceE5DE0E009A1D4E02A3EDB807372C275BData();
   ...
   private PriceE5DE0E009A1D4E02A3EDB807372C275BData[] getRelationData(PriceE5DE0E009A1D4E02A3EDB807372C275BData[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strM_ProductPrice_ID) throws ServletException {
    String strPM_Product_ID = PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectParentID(this, strM_ProductPrice_ID);
    if (strPM_Product_ID.equals("")) {
...
String strParamM_PriceList_Version_ID = vars.getSessionValue(tabId + "|paramM_PriceList_Version_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/PriceE5DE0E009A1D4E02A3EDB807372C275B_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PriceE5DE0E009A1D4E02A3EDB807372C275B", false, "document.frmMain.inpmProductpriceId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PriceE5DE0E009A1D4E02A3EDB807372C275B_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "PriceE5DE0E009A1D4E02A3EDB807372C275B_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectParent(this, vars.getLanguage(), strPM_Product_ID));
    else xmlDocument.setParameter("parent", PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectParentTrl(this, vars.getLanguage(), strPM_Product_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_ProductPrice_ID, String strPM_Product_ID, TableSQLData tableSQL)
    ...
    PriceE5DE0E009A1D4E02A3EDB807372C275BData[] data=null;
...
String strParamM_PriceList_Version_ID = vars.getSessionValue(tabId + "|paramM_PriceList_Version_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Product_ID, strM_ProductPrice_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new PriceE5DE0E009A1D4E02A3EDB807372C275BData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceE5DE0E009A1D4E02A3EDB807372C275BData.set(strPM_Product_ID, Utility.getDefault(this, vars, "PriceList", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectDef2064_0(this, strPM_Product_ID), Utility.getDefault(this, vars, "PriceStd", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), "Y", Utility.getDefault(this, vars, "PriceLimit", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectDef2060_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField)), "", Utility.getDefault(this, vars, "M_PriceList_Version_ID", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField), PriceE5DE0E009A1D4E02A3EDB807372C275BData.selectDef2062_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "E5DE0E009A1D4E02A3EDB807372C275B", "", dataField)));
        
      }
    } else {
      data = new PriceE5DE0E009A1D4E02A3EDB807372C275BData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(PriceE5DE0E009A1D4E02A3EDB807372C275BData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PriceE5DE0E009A1D4E02A3EDB807372C275B", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmProductpriceId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_ProductPrice_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (PriceE5DE0E009A1D4E02A3EDB807372C275BData.getCurrentDBTimestamp(this, data.mProductpriceId).equals(
  ...
  public String getServletInfo() {
    return "Servlet PriceE5DE0E009A1D4E02A3EDB807372C275B. This Servlet was made by Wad constructor";
