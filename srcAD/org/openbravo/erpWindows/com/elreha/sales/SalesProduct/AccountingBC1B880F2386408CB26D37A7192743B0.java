...
public class AccountingBC1B880F2386408CB26D37A7192743B0 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(AccountingBC1B880F2386408CB26D37A7192743B0.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "BC1B880F2386408CB26D37A7192743B0";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(windowId + "|M_Product_ID", strPM_Product_ID);
      vars.setSessionValue("F6A25D6EA3384B0C85679865687E51D4|Product.view", "EDIT");

      refreshParentSession(vars, strPM_Product_ID);

      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.view", "EDIT");

        printPageEdit(response, request, vars, false, strM_Product_Acct_ID, strPM_Product_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamC_AcctSchema_ID", tabId + "|paramC_AcctSchema_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Product_Acct_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");
      ...
      vars.setSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|AccountingBC1B880F2386408CB26D37A7192743B0.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Product_Acct_ID");
      vars.setSessionValue(windowId + "|M_Product_ID", strPM_Product_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strM_Product_Acct_ID = vars.getRequiredStringParameter("inpmProductAcctId");
      //AccountingBC1B880F2386408CB26D37A7192743B0Data data = getEditVariables(vars, strPM_Product_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = AccountingBC1B880F2386408CB26D37A7192743B0Data.delete(this, strM_Product_Acct_ID, strPM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strM_Product_Acct_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (AccountingBC1B880F2386408CB26D37A7192743B0Data.deleteTransactional(conn, this, strKey, strPM_Product_ID)==0) {
...
*/
  private AccountingBC1B880F2386408CB26D37A7192743B0Data getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
    AccountingBC1B880F2386408CB26D37A7192743B0Data data = new AccountingBC1B880F2386408CB26D37A7192743B0Data();
   ...
   private AccountingBC1B880F2386408CB26D37A7192743B0Data[] getRelationData(AccountingBC1B880F2386408CB26D37A7192743B0Data[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Product_Acct_ID) throws ServletException {
    String strPM_Product_ID = AccountingBC1B880F2386408CB26D37A7192743B0Data.selectParentID(this, strM_Product_Acct_ID);
    if (strPM_Product_ID.equals("")) {
...
String strParamC_AcctSchema_ID = vars.getSessionValue(tabId + "|paramC_AcctSchema_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/AccountingBC1B880F2386408CB26D37A7192743B0_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "AccountingBC1B880F2386408CB26D37A7192743B0", false, "document.frmMain.inpmProductAcctId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "AccountingBC1B880F2386408CB26D37A7192743B0_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "AccountingBC1B880F2386408CB26D37A7192743B0_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", AccountingBC1B880F2386408CB26D37A7192743B0Data.selectParent(this, vars.getLanguage(), strPM_Product_ID));
    else xmlDocument.setParameter("parent", AccountingBC1B880F2386408CB26D37A7192743B0Data.selectParentTrl(this, vars.getLanguage(), strPM_Product_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Product_Acct_ID, String strPM_Product_ID, TableSQLData tableSQL)
    ...
    AccountingBC1B880F2386408CB26D37A7192743B0Data[] data=null;
...
String strParamC_AcctSchema_ID = vars.getSessionValue(tabId + "|paramC_AcctSchema_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = AccountingBC1B880F2386408CB26D37A7192743B0Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Product_ID, strM_Product_Acct_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new AccountingBC1B880F2386408CB26D37A7192743B0Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = AccountingBC1B880F2386408CB26D37A7192743B0Data.set(strPM_Product_ID, Utility.getDefault(this, vars, "P_PurchasePriceVariance_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef5109_0(this, Utility.getDefault(this, vars, "P_PurchasePriceVariance_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "P_TradeDiscountRec_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef6119_1(this, Utility.getDefault(this, vars, "P_TradeDiscountRec_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef2565_2(this, strPM_Product_ID), Utility.getDefault(this, vars, "P_TradeDiscountGrant_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef6120_3(this, Utility.getDefault(this, vars, "P_TradeDiscountGrant_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef2562_4(this, Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), "Y", Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef2564_5(this, Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "P_InvoicePriceVariance_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef6118_6(this, Utility.getDefault(this, vars, "P_InvoicePriceVariance_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "P_Revenue_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef31D8E17FACF74378B93278F16F34DA5E_7(this, Utility.getDefault(this, vars, "P_Revenue_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "C_AcctSchema_ID", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), "", Utility.getDefault(this, vars, "P_Expense_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDefDF4C8A3C70804B2FB2631E62C2DF7E1F_8(this, Utility.getDefault(this, vars, "P_Expense_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "P_Cogs_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef3421_9(this, Utility.getDefault(this, vars, "P_Cogs_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), Utility.getDefault(this, vars, "P_Asset_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField), AccountingBC1B880F2386408CB26D37A7192743B0Data.selectDef3420_10(this, Utility.getDefault(this, vars, "P_Asset_Acct", "", "6614375915A04200ACCE9C693F0651E2", "BC1B880F2386408CB26D37A7192743B0", "", dataField)));
        
      }
    } else {
      data = new AccountingBC1B880F2386408CB26D37A7192743B0Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(AccountingBC1B880F2386408CB26D37A7192743B0Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "AccountingBC1B880F2386408CB26D37A7192743B0", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmProductAcctId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Product_Acct_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (AccountingBC1B880F2386408CB26D37A7192743B0Data.getCurrentDBTimestamp(this, data.mProductAcctId).equals(
  ...
  public String getServletInfo() {
    return "Servlet AccountingBC1B880F2386408CB26D37A7192743B0. This Servlet was made by Wad constructor";
