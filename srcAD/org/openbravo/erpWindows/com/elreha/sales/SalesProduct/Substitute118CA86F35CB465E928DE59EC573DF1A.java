...
public class Substitute118CA86F35CB465E928DE59EC573DF1A extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Substitute118CA86F35CB465E928DE59EC573DF1A.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "118CA86F35CB465E928DE59EC573DF1A";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.view", "EDIT");

        printPageEdit(response, request, vars, false, strM_Substitute_ID, strPM_Product_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamName", tabId + "|paramName");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Substitute_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");
      ...
      vars.setSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Substitute118CA86F35CB465E928DE59EC573DF1A.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Substitute_ID");
      vars.setSessionValue(windowId + "|M_Product_ID", strPM_Product_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strM_Substitute_ID = vars.getRequiredStringParameter("inpmSubstituteId");
      //Substitute118CA86F35CB465E928DE59EC573DF1AData data = getEditVariables(vars, strPM_Product_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Substitute118CA86F35CB465E928DE59EC573DF1AData.delete(this, strM_Substitute_ID, strPM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strM_Substitute_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (Substitute118CA86F35CB465E928DE59EC573DF1AData.deleteTransactional(conn, this, strKey, strPM_Product_ID)==0) {
...
*/
  private Substitute118CA86F35CB465E928DE59EC573DF1AData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
    Substitute118CA86F35CB465E928DE59EC573DF1AData data = new Substitute118CA86F35CB465E928DE59EC573DF1AData();
   ...
   private Substitute118CA86F35CB465E928DE59EC573DF1AData[] getRelationData(Substitute118CA86F35CB465E928DE59EC573DF1AData[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Substitute_ID) throws ServletException {
    String strPM_Product_ID = Substitute118CA86F35CB465E928DE59EC573DF1AData.selectParentID(this, strM_Substitute_ID);
    if (strPM_Product_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
      Substitute118CA86F35CB465E928DE59EC573DF1AData[] data = Substitute118CA86F35CB465E928DE59EC573DF1AData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Product_ID, vars.getStringParameter("inpmSubstituteId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPM_Product_ID, String strM_Substitute_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/Substitute118CA86F35CB465E928DE59EC573DF1A_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Substitute118CA86F35CB465E928DE59EC573DF1A", false, "document.frmMain.inpmSubstituteId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Substitute118CA86F35CB465E928DE59EC573DF1A_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Substitute118CA86F35CB465E928DE59EC573DF1A_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Substitute118CA86F35CB465E928DE59EC573DF1AData.selectParent(this, vars.getLanguage(), strPM_Product_ID));
    else xmlDocument.setParameter("parent", Substitute118CA86F35CB465E928DE59EC573DF1AData.selectParentTrl(this, vars.getLanguage(), strPM_Product_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Substitute_ID, String strPM_Product_ID, TableSQLData tableSQL)
    ...
    Substitute118CA86F35CB465E928DE59EC573DF1AData[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Substitute118CA86F35CB465E928DE59EC573DF1AData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Product_ID, strM_Substitute_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Substitute118CA86F35CB465E928DE59EC573DF1AData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Substitute118CA86F35CB465E928DE59EC573DF1AData.set(strPM_Product_ID, Substitute118CA86F35CB465E928DE59EC573DF1AData.selectDef1782_0(this, strPM_Product_ID), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField), Substitute118CA86F35CB465E928DE59EC573DF1AData.selectDef1442_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField)), "Y", Utility.getDefault(this, vars, "Name", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField), "", Utility.getDefault(this, vars, "Substitute_ID", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField), Substitute118CA86F35CB465E928DE59EC573DF1AData.selectDef1783_2(this, Utility.getDefault(this, vars, "Substitute_ID", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField)), Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField), Substitute118CA86F35CB465E928DE59EC573DF1AData.selectDef1440_3(this, Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "118CA86F35CB465E928DE59EC573DF1A", "", dataField)));
        
      }
    } else {
      data = new Substitute118CA86F35CB465E928DE59EC573DF1AData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Substitute118CA86F35CB465E928DE59EC573DF1AData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Substitute118CA86F35CB465E928DE59EC573DF1A", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmSubstituteId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Substitute_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Substitute118CA86F35CB465E928DE59EC573DF1AData.getCurrentDBTimestamp(this, data.mSubstituteId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Substitute118CA86F35CB465E928DE59EC573DF1A. This Servlet was made by Wad constructor";
