...
public class PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "E98B8C7793CD43A8A8271CB2DBD919F5";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.view", "EDIT");

        printPageEdit(response, request, vars, false, strMRP_Inoutplan_V_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamPlanneddate_f", tabId + "|paramPlanneddate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strMRP_Inoutplan_V_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|MRP_Inoutplan_V_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strMRP_Inoutplan_V_ID = vars.getRequiredStringParameter("inpmrpInoutplanVId");
      //PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.delete(this, strMRP_Inoutplan_V_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strMRP_Inoutplan_V_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data data = new PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data();
   ...
   private PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data[] getRelationData(PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data[] data = PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "M_PRODUCT_ID", windowId), vars.getStringParameter("inpmrpInoutplanVId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamPlanneddate_f = vars.getSessionValue(tabId + "|paramPlanneddate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5", false, "document.frmMain.inpmrpInoutplanVId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMRP_Inoutplan_V_ID, TableSQLData tableSQL)
    ...
    PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data[] data=null;
...
String strParamPlanneddate_f = vars.getSessionValue(tabId + "|paramPlanneddate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "M_PRODUCT_ID", windowId), strMRP_Inoutplan_V_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.set(Utility.getDefault(this, vars, "Updatedby", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.selectDef2F04CE6BDC284E2C80162ECBDD4A2984_0(this, Utility.getDefault(this, vars, "Updatedby", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField)), Utility.getDefault(this, vars, "Documenttype", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), "Y", Utility.getDefault(this, vars, "Movementqty", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.selectDefF082229707444D7BB13B9D59C0DD1B08_1(this, Utility.getDefault(this, vars, "Createdby", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), "", Utility.getDefault(this, vars, "M_Product_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.selectDef7719E258DAF24AE1BDEE48E95ECCA4AE_2(this, Utility.getDefault(this, vars, "M_Product_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField)), Utility.getDefault(this, vars, "C_Uom_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.selectDefB92C73B63EE140898CC7EE877DE8A96E_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField)), Utility.getDefault(this, vars, "Estimated_Stock_Qty", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "Planneddate", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "C_Orderline_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField), Utility.getDefault(this, vars, "M_Product_Category_ID", "", "6614375915A04200ACCE9C693F0651E2", "E98B8C7793CD43A8A8271CB2DBD919F5", "", dataField));
        
      }
    } else {
      data = new PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmrpInoutplanVId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMRP_Inoutplan_V_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5Data.getCurrentDBTimestamp(this, data.mrpInoutplanVId).equals(
  ...
  public String getServletInfo() {
    return "Servlet PlannedMaterialMovementsE98B8C7793CD43A8A8271CB2DBD919F5. This Servlet was made by Wad constructor";
