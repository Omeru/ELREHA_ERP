...
public class BillofMaterials2EE104C8D2014E7F89452799303D14EF extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(BillofMaterials2EE104C8D2014E7F89452799303D14EF.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "2EE104C8D2014E7F89452799303D14EF";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.view", "EDIT");

        printPageEdit(response, request, vars, false, strM_Product_BOM_ID, strPM_Product_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamConstuctivemeasure", tabId + "|paramConstuctivemeasure");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Product_BOM_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.view", strView);
        }
      }
...
vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");
      ...
      vars.setSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|BillofMaterials2EE104C8D2014E7F89452799303D14EF.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Product_BOM_ID");
      vars.setSessionValue(windowId + "|M_Product_ID", strPM_Product_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strM_Product_BOM_ID = vars.getRequiredStringParameter("inpmProductBomId");
      //BillofMaterials2EE104C8D2014E7F89452799303D14EFData data = getEditVariables(vars, strPM_Product_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = BillofMaterials2EE104C8D2014E7F89452799303D14EFData.delete(this, strM_Product_BOM_ID, strPM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strM_Product_BOM_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (BillofMaterials2EE104C8D2014E7F89452799303D14EFData.deleteTransactional(conn, this, strKey, strPM_Product_ID)==0) {
...
*/
  private BillofMaterials2EE104C8D2014E7F89452799303D14EFData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
    BillofMaterials2EE104C8D2014E7F89452799303D14EFData data = new BillofMaterials2EE104C8D2014E7F89452799303D14EFData();
   ...
   private BillofMaterials2EE104C8D2014E7F89452799303D14EFData[] getRelationData(BillofMaterials2EE104C8D2014E7F89452799303D14EFData[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Product_BOM_ID) throws ServletException {
    String strPM_Product_ID = BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectParentID(this, strM_Product_BOM_ID);
    if (strPM_Product_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|M_Product_ID", data[0].getField("mProductId"));    vars.setSessionValue(windowId + "|M_Product__ID", data[0].getField("mProductId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPM_Product_ID) throws IOException,ServletException {
      BillofMaterials2EE104C8D2014E7F89452799303D14EFData[] data = BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Product_ID, vars.getStringParameter("inpmProductBomId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamConstuctivemeasure = vars.getSessionValue(tabId + "|paramConstuctivemeasure");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/BillofMaterials2EE104C8D2014E7F89452799303D14EF_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "BillofMaterials2EE104C8D2014E7F89452799303D14EF", false, "document.frmMain.inpmProductBomId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "BillofMaterials2EE104C8D2014E7F89452799303D14EF_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "BillofMaterials2EE104C8D2014E7F89452799303D14EF_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectParent(this, vars.getLanguage(), strPM_Product_ID));
    else xmlDocument.setParameter("parent", BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectParentTrl(this, vars.getLanguage(), strPM_Product_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Product_BOM_ID, String strPM_Product_ID, TableSQLData tableSQL)
    ...
    BillofMaterials2EE104C8D2014E7F89452799303D14EFData[] data=null;
...
String strParamConstuctivemeasure = vars.getSessionValue(tabId + "|paramConstuctivemeasure");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Product_ID, strM_Product_BOM_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new BillofMaterials2EE104C8D2014E7F89452799303D14EFData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = BillofMaterials2EE104C8D2014E7F89452799303D14EFData.set(strPM_Product_ID, Utility.getDefault(this, vars, "Product_Value", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectDef4721_0(this, strPM_Product_ID), Utility.getDefault(this, vars, "BOMType", "P", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectDef4770(this, strPM_Product_ID), Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectDef4718_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField)), Utility.getDefault(this, vars, "BOMQty", "1", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), Utility.getDefault(this, vars, "Description", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), Utility.getDefault(this, vars, "Constuctivemeasure", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), Utility.getDefault(this, vars, "M_ProductBOM_ID", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectDef4722_2(this, Utility.getDefault(this, vars, "M_ProductBOM_ID", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField)), Utility.getDefault(this, vars, "Rawmaterial", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), "", Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectDef03A847352F8A4518A7C5BDB31644E23D_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField), BillofMaterials2EE104C8D2014E7F89452799303D14EFData.selectDef4720_4(this, Utility.getDefault(this, vars, "UpdatedBy", "", "6614375915A04200ACCE9C693F0651E2", "2EE104C8D2014E7F89452799303D14EF", "", dataField)));
        
      }
    } else {
      data = new BillofMaterials2EE104C8D2014E7F89452799303D14EFData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(BillofMaterials2EE104C8D2014E7F89452799303D14EFData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "BillofMaterials2EE104C8D2014E7F89452799303D14EF", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmProductBomId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Product_BOM_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (BillofMaterials2EE104C8D2014E7F89452799303D14EFData.getCurrentDBTimestamp(this, data.mProductBomId).equals(
  ...
  public String getServletInfo() {
    return "Servlet BillofMaterials2EE104C8D2014E7F89452799303D14EF. This Servlet was made by Wad constructor";
