...
public class SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.class);
  
  private static final String windowId = "6614375915A04200ACCE9C693F0651E2";
  private static final String tabId = "B8355A05CFB244C8A081C0C232BC2752";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.view", "EDIT");

        printPageEdit(response, request, vars, false, strSNR_Serialnumbertracking_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamGuaranteedate_f", tabId + "|paramGuaranteedate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strSNR_Serialnumbertracking_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|SNR_Serialnumbertracking_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strSNR_Serialnumbertracking_ID = vars.getRequiredStringParameter("inpsnrSerialnumbertrackingId");
      //SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.delete(this, strSNR_Serialnumbertracking_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strSNR_Serialnumbertracking_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data[] getRelationData(SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data[] data = SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "snr_masterdata_ID", windowId), vars.getStringParameter("inpsnrSerialnumbertrackingId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/elreha/sales/SalesProduct/SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752", false, "document.frmMain.inpsnrSerialnumbertrackingId", "grid", "..", "".equals("Y"), "SalesProduct", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752_Relation.html", "SalesProduct", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strSNR_Serialnumbertracking_ID, TableSQLData tableSQL)
    ...
    SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data[] data=null;
...
String strParamGuaranteedate_f = vars.getSessionValue(tabId + "|paramGuaranteedate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "snr_masterdata_ID", windowId), strSNR_Serialnumbertracking_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.set(Utility.getDefault(this, vars, "M_Inoutline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDef90CAE05DF99641938BECABEA651659F3_0(this, Utility.getDefault(this, vars, "M_Inoutline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Assembly_Productid", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefA71F774962944D41B980C9C2D5B34669_1(this, Utility.getDefault(this, vars, "Assembly_Productid", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Guaranteedays", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Movement_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), "Y", "", Utility.getDefault(this, vars, "Description", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefD6E8C36F2B8F4CC7AB52999AB9D274DA_2(this, Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefFE03AA8BA4B7448088819DDAB664189F_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Quantity", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Inventoryline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Inout_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefB78C46BB7000448EA0E2B35DF351ADC6_4(this, Utility.getDefault(this, vars, "M_Inout_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Movementdate", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Internal_Consumptionline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "Guaranteedate", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "Lotnumber", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "Rfidnumber", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Movementline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "Docstatus", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDef775B3326D4104402A931CEDBFEA06933_5(this, Utility.getDefault(this, vars, "Createdby", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Serialnumber", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefC25C3D6A592D47C8B084245749AD006C_6(this, Utility.getDefault(this, vars, "M_Locator_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "C_Project_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDef4F68001A1827490B8E25617CCFE9A835_7(this, Utility.getDefault(this, vars, "C_Project_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Movementtype", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Internal_Consumption_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "C_Orderline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDef8E2C92CCC5F547E998DC56323ADBAB8F_8(this, Utility.getDefault(this, vars, "C_Orderline_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "Assembly_Snr", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefED4444A033624267A14E465923306FF7_9(this, Utility.getDefault(this, vars, "M_Product_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField), SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.selectDefABA0AE095068430AAF34BB38C525657A_10(this, Utility.getDefault(this, vars, "Updatedby", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField)), Utility.getDefault(this, vars, "M_Inventory_ID", "", "6614375915A04200ACCE9C693F0651E2", "B8355A05CFB244C8A081C0C232BC2752", "", dataField));
        
      }
    } else {
      data = new SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpsnrSerialnumbertrackingId", "", "..", "".equals("Y"), "SalesProduct", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strSNR_Serialnumbertracking_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752Data.getCurrentDBTimestamp(this, data.snrSerialnumbertrackingId).equals(
  ...
  public String getServletInfo() {
    return "Servlet SerialNumberTransactionsB8355A05CFB244C8A081C0C232BC2752. This Servlet was made by Wad constructor";
