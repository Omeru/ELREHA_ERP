...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strZSE_Shopupdatelog_ID = vars.getRequiredInStringParameter("inpzseShopupdatelogId");
      String message = deleteRelation(vars, strZSE_Shopupdatelog_ID, strPZSE_Shop_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strZSE_Shopupdatelog_ID, String strPZSE_Shop_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strZSE_Shopupdatelog_ID.startsWith("(")) strZSE_Shopupdatelog_ID = strZSE_Shopupdatelog_ID.substring(1, strZSE_Shopupdatelog_ID.length()-1);
      if (!strZSE_Shopupdatelog_ID.equals("")) {
        strZSE_Shopupdatelog_ID = Replace.replace(strZSE_Shopupdatelog_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strZSE_Shopupdatelog_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (OnlineUpdateProcessControlEF17ECFDF3F94803B037F5DD37CD1548Data.deleteTransactional(conn, this, strKey, strPZSE_Shop_ID)==0) {
...
*/
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPZSE_Shop_ID, String strZSE_Shopupdatelog_ID, TableSQLData tableSQL)
    ...
    if (!(strParamZSE_Shop_ID.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/ecommerce/ShopMaintanance/OnlineUpdateProcessControlEF17ECFDF3F94803B037F5DD37CD1548_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "OnlineUpdateProcessControlEF17ECFDF3F94803B037F5DD37CD1548", false, "document.frmMain.inpzseShopupdatelogId", "grid", "..", "".equals("Y"), "ShopMaintanance", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "OnlineUpdateProcessControlEF17ECFDF3F94803B037F5DD37CD1548_Relation.html", "ShopMaintanance", "W", strReplaceWith, tabs.breadcrumb());
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZSE_Shopupdatelog_ID, String strPZSE_Shop_ID, TableSQLData tableSQL)
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "OnlineUpdateProcessControlEF17ECFDF3F94803B037F5DD37CD1548", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzseShopupdatelogId", "", "..", "".equals("Y"), "ShopMaintanance", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZSE_Shopupdatelog_ID));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPZSE_Shop_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zseShopupdatelogId, vars, this);
        } catch(Exception ex) {
