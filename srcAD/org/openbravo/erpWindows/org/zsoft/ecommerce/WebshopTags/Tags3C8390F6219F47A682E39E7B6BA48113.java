   ...
   private Tags3C8390F6219F47A682E39E7B6BA48113Data[] getRelationData(Tags3C8390F6219F47A682E39E7B6BA48113Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|ZSE_Tag_ID", data[0].getField("zseTagId"));
    }
