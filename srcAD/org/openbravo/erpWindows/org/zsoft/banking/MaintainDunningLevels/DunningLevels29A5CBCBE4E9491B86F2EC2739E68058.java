   ...
   private DunningLevels29A5CBCBE4E9491B86F2EC2739E68058Data[] getRelationData(DunningLevels29A5CBCBE4E9491B86F2EC2739E68058Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|C_Dunning_ID", data[0].getField("cDunningId"));
    }
