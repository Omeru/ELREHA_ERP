   ...
   private SerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[] getRelationData(SerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|Serialnumber", data[0].getField("serialnumber"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|SNR_Masterdata_ID", data[0].getField("snrMasterdataId"));
    }
