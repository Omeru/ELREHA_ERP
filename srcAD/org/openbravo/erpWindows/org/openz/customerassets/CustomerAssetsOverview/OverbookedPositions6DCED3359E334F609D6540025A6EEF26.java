   ...
   private OverbookedPositions6DCED3359E334F609D6540025A6EEF26Data[] getRelationData(OverbookedPositions6DCED3359E334F609D6540025A6EEF26Data[] data) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|CA_Overbookedbulkpositions_V_ID", data[0].getField("caOverbookedbulkpositionsVId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
