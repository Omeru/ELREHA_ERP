...
vars.getRequestGlobalVariable("inpParamWmonth_f", tabId + "|paramWmonth_f");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Empworktimeaccount_ID = vars.getRequiredInStringParameter("inpcEmpworktimeaccountId");
      String message = deleteRelation(vars, strC_Empworktimeaccount_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strC_Empworktimeaccount_ID) throws IOException, ServletException {
    log4j.debug("Deleting records");
    Connection conn = this.getTransactionConnection();
    try {
      if (strC_Empworktimeaccount_ID.startsWith("(")) strC_Empworktimeaccount_ID = strC_Empworktimeaccount_ID.substring(1, strC_Empworktimeaccount_ID.length()-1);
      if (!strC_Empworktimeaccount_ID.equals("")) {
        strC_Empworktimeaccount_ID = Replace.replace(strC_Empworktimeaccount_ID, "'", "");
        StringTokenizer st = new StringTokenizer(strC_Empworktimeaccount_ID, ",", false);
        while (st.hasMoreTokens()) {
          String strKey = st.nextToken();
          if (WorktimeAccount7D13783F51684D14A6C4C77D3AFF7828Data.deleteTransactional(conn, this, strKey)==0) {
...
String strParamWmonth_f = vars.getSessionValue(tabId + "|paramWmonth_f");
    ...
    if (!(strParamad_user_ID.equals("") && strParamWyear.equals("") && strParamWmonth.equals("") && strParamWyear_f.equals("") && strParamWmonth_f.equals(""))) hasSearchCondition=true;
    String strOffset = "0";
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cEmpworktimeaccountId, vars, this);
        } catch(Exception ex) {
