...
public class CalendarEventsCF9A69DE803447F6A49DE55F29913397 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(CalendarEventsCF9A69DE803447F6A49DE55F29913397.class);
  
  private static final String windowId = "82ED989E0C8746D4A95A7034F2895E0E";
  private static final String tabId = "CF9A69DE803447F6A49DE55F29913397";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_Bpartneremployeeevent_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamDateto_f", tabId + "|paramDateto_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_Bpartneremployeeevent_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|CalendarEventsCF9A69DE803447F6A49DE55F29913397.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_Bpartneremployeeevent_ID");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_Bpartneremployeeevent_ID = vars.getRequiredStringParameter("inpcBpartneremployeeeventId");
      //CalendarEventsCF9A69DE803447F6A49DE55F29913397Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.delete(this, strC_Bpartneremployeeevent_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strC_Bpartneremployeeevent_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.deleteTransactional(conn, this, strKey)==0) {
...
*/
  private CalendarEventsCF9A69DE803447F6A49DE55F29913397Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    CalendarEventsCF9A69DE803447F6A49DE55F29913397Data data = new CalendarEventsCF9A69DE803447F6A49DE55F29913397Data();
   ...
   private CalendarEventsCF9A69DE803447F6A49DE55F29913397Data[] getRelationData(CalendarEventsCF9A69DE803447F6A49DE55F29913397Data[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      CalendarEventsCF9A69DE803447F6A49DE55F29913397Data[] data = CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "employee_id", windowId), vars.getStringParameter("inpcBpartneremployeeeventId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamDateto_f = vars.getSessionValue(tabId + "|paramDateto_f");
    ...
    if (vars.getSessionValue(windowId +  "|Tsrv_Feedback_V_ID").isEmpty()) vars.setSessionValue(windowId + "|Tsrv_Feedback_V_ID", vars.getStringParameter("inptsrvFeedbackVId"));
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openz/timeservice/WorkFeedback/CalendarEventsCF9A69DE803447F6A49DE55F29913397_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "CalendarEventsCF9A69DE803447F6A49DE55F29913397", false, "document.frmMain.inpcBpartneremployeeeventId", "grid", "..", "".equals("Y"), "WorkFeedback", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "CalendarEventsCF9A69DE803447F6A49DE55F29913397_Relation.html", "WorkFeedback", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "CalendarEventsCF9A69DE803447F6A49DE55F29913397_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Bpartneremployeeevent_ID, TableSQLData tableSQL)
    ...
    CalendarEventsCF9A69DE803447F6A49DE55F29913397Data[] data=null;
...
String strParamDateto_f = vars.getSessionValue(tabId + "|paramDateto_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "employee_id", windowId), strC_Bpartneremployeeevent_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new CalendarEventsCF9A69DE803447F6A49DE55F29913397Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.set(Utility.getDefault(this, vars, "Createdby", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.selectDefF20C91E3BC1B46B384FD44CCDAF10471_0(this, Utility.getDefault(this, vars, "Createdby", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField)), Utility.getDefault(this, vars, "C_Calendarevent_ID", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "Dateto", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "Datefrom", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.selectDef0C53B14C4540481FA38D5E0B005FD8EC_1(this, Utility.getDefault(this, vars, "Updatedby", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField)), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), "", "Y", Utility.getDefault(this, vars, "Note", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "Worktime", "", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "", dataField), Utility.getDefault(this, vars, "Reminder", "N", "82ED989E0C8746D4A95A7034F2895E0E", "CF9A69DE803447F6A49DE55F29913397", "N", dataField));
        
      }
    } else {
      data = new CalendarEventsCF9A69DE803447F6A49DE55F29913397Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(CalendarEventsCF9A69DE803447F6A49DE55F29913397Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "CalendarEventsCF9A69DE803447F6A49DE55F29913397", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcBpartneremployeeeventId", "", "..", "".equals("Y"), "WorkFeedback", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Bpartneremployeeevent_ID));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (CalendarEventsCF9A69DE803447F6A49DE55F29913397Data.getCurrentDBTimestamp(this, data.cBpartneremployeeeventId).equals(
  ...
  public String getServletInfo() {
    return "Servlet CalendarEventsCF9A69DE803447F6A49DE55F29913397. This Servlet was made by Wad constructor";
