...
public class SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.class);
  
  private static final String windowId = "3B800C41F0DC4618B81E4295E9E2B232";
  private static final String tabId = "E34980E9DCF6499A8A886A45D9D60B75";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_BPartner_ID, strPC_BPartner_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.view", "RELATION");
...
vars.getRequestGlobalVariable("inpParamAD_Org_ID", tabId + "|paramAD_Org_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_BPartner_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");
      ...
      vars.setSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_BPartner_ID = vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_BPartner_ID");
      vars.setSessionValue(windowId + "|C_BPartner_ID", strPC_BPartner_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String strC_BPartner_ID = vars.getRequiredStringParameter("inpcBpartnerId");
      //SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data data = getEditVariables(vars, strPC_BPartner_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.delete(this, strC_BPartner_ID, strPC_BPartner_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
    ...
    try {
      ...
      if (!strC_BPartner_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.deleteTransactional(conn, this, strKey, strPC_BPartner_ID)==0) {
...
*/
  private SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
    SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data data = new SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data();
    ServletException ex = null;
    try {
    data.value = vars.getRequestGlobalVariable("inpvalue", windowId + "|Value");     data.name = vars.getStringParameter("inpname");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.isvendor = vars.getStringParameter("inpisvendor", "N");     data.paymentrulepo = vars.getStringParameter("inppaymentrulepo");     data.paymentrulepor = vars.getStringParameter("inppaymentrulepo_R");     data.poPaymenttermId = vars.getStringParameter("inppoPaymenttermId");     data.poPaymenttermIdr = vars.getStringParameter("inppoPaymenttermId_R");     data.poPricelistId = vars.getStringParameter("inppoPricelistId");     data.poPricelistIdr = vars.getStringParameter("inppoPricelistId_R");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.iscreditcard = vars.getStringParameter("inpiscreditcard", "N");    try {   data.poFixmonthday = vars.getNumericParameter("inppoFixmonthday");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.poFixmonthday3 = vars.getNumericParameter("inppoFixmonthday3");  } catch (ServletException paramEx) { ex = paramEx; }     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");    try {   data.poFixmonthday2 = vars.getNumericParameter("inppoFixmonthday2");  } catch (ServletException paramEx) { ex = paramEx; }     data.cBpartnerId = vars.getRequestGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID"); 
  ...
  private String getParentID(VariablesSecureApp vars, String strC_BPartner_ID) throws ServletException {
    String strPC_BPartner_ID = SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectParentID(this, strC_BPartner_ID);
    if (strPC_BPartner_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
      SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data[] data = SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "C_BPARTNER_ID", windowId), strPC_BPartner_ID, vars.getStringParameter("inpcBpartnerId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openz/modules/multilevelmarketing/EmployeeMLM/SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75", false, "document.frmMain.inpcBpartnerId", "grid", "..", "".equals("Y"), "EmployeeMLM", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75_Relation.html", "EmployeeMLM", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectParent(this, strPC_BPartner_ID));
    else xmlDocument.setParameter("parent", SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectParentTrl(this, strPC_BPartner_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_BPartner_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data[] data=null;
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    if (dataField==null) {
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.set(strPC_BPartner_ID, Utility.getDefault(this, vars, "PO_PriceList_ID", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), Utility.getDefault(this, vars, "PO_Fixmonthday3", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectDef2901(this, Utility.getContext(this, vars, "AD_ORG_ID", "3B800C41F0DC4618B81E4295E9E2B232")), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), Utility.getDefault(this, vars, "Name", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), Utility.getDefault(this, vars, "PaymentRulePO", "R", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), "Y", Utility.getDefault(this, vars, "IsVendor", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectDef2898_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), Utility.getDefault(this, vars, "PO_PaymentTerm_ID", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), Utility.getDefault(this, vars, "IsCreditcard", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.selectDef2900_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField)), Utility.getDefault(this, vars, "PO_Fixmonthday", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField), Utility.getDefault(this, vars, "PO_Fixmonthday2", "", "3B800C41F0DC4618B81E4295E9E2B232", "E34980E9DCF6499A8A886A45D9D60B75", "", dataField));
        
      }
    } else {
      data = new SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75Data.getCurrentDBTimestamp(this, data.cBpartnerId).equals(
  ...
  public String getServletInfo() {
    return "Servlet SalesRepVendorE34980E9DCF6499A8A886A45D9D60B75. This Servlet was made by Wad constructor";
