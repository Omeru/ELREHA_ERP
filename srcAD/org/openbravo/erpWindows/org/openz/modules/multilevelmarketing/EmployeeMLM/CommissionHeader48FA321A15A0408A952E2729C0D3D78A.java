...
/*    } else if (vars.commandIn("DELETE_RELATION")) {
      ...
      String message = deleteRelation(vars, strC_Commission_ID, strPC_BPartner_ID);
      if (!message.equals("")) {
...
/*
  String deleteRelation(VariablesSecureApp vars, String strC_Commission_ID, String strPC_BPartner_ID) throws IOException, ServletException {
    ...
    try {
      ...
      if (!strC_Commission_ID.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (CommissionHeader48FA321A15A0408A952E2729C0D3D78AData.deleteTransactional(conn, this, strKey, strPC_BPartner_ID)==0) {
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Commission_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CommissionHeader48FA321A15A0408A952E2729C0D3D78AData.set(strPC_BPartner_ID, Utility.getDefault(this, vars, "Shareofturnoverpartner", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), "", Utility.getDefault(this, vars, "Description", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "ListDetails", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), CommissionHeader48FA321A15A0408A952E2729C0D3D78AData.selectDef5674_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField)), "Y", Utility.getDefault(this, vars, "DateLastRun", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "Shareofturnoverpercent", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), CommissionHeader48FA321A15A0408A952E2729C0D3D78AData.selectDef802829_1(this, Utility.getDefault(this, vars, "M_Product_ID", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField)), Utility.getDefault(this, vars, "Name", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "Processing", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), CommissionHeader48FA321A15A0408A952E2729C0D3D78AData.selectDef5672_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField)), Utility.getDefault(this, vars, "DocBasisType", "I", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), CommissionHeader48FA321A15A0408A952E2729C0D3D78AData.selectDef5677_3(this, strPC_BPartner_ID), Utility.getDefault(this, vars, "FrequencyType", "M", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "N", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "3B800C41F0DC4618B81E4295E9E2B232", "48FA321A15A0408A952E2729C0D3D78A", "", dataField));
