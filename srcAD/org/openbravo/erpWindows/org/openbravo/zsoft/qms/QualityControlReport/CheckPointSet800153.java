...
String strParamMA_Measure_Shift_ID = vars.getSessionValue(tabId + "|paramMA_Measure_Shift_ID");
    ...
    if (vars.getSessionValue(windowId +  "|MA_Measure_Shift_ID").isEmpty()) vars.setSessionValue(windowId + "|MA_Measure_Shift_ID", vars.getStringParameter("inpmaMeasureShiftId"));
