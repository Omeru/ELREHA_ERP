...
*/
  private Main8FBAA16AD68140C8AF41D76BB9B882F1Data getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private Main8FBAA16AD68140C8AF41D76BB9B882F1Data[] getRelationData(Main8FBAA16AD68140C8AF41D76BB9B882F1Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].zssiNotes4customerId = FormatUtilities.truncate(data[i].zssiNotes4customerId, 32);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 32);        data[i].typeofcontact = FormatUtilities.truncate(data[i].typeofcontact, 50);        data[i].contactto = FormatUtilities.truncate(data[i].contactto, -5);        data[i].emp = FormatUtilities.truncate(data[i].emp, 50);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].zssiCrmTodosId = FormatUtilities.truncate(data[i].zssiCrmTodosId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);}
    }
    return data;
  }
