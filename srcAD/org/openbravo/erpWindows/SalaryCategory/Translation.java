...
*/
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Salary_Category_Trl_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Salary_Category_Trl_ID", data[0].getField("cSalaryCategoryTrlId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
