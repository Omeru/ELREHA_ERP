...
public class ActionButton_Responser extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    } else if (vars.commandIn("BUTTON5FB0B21BF50F4384B58CDBD39D45CA06")) {
        
        printPageButton5FB0B21BF50F4384B58CDBD39D45CA06(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("BUTTON9124E14C358140FCA23DB0E48F120ADB")) {
        
        printPageButton9124E14C358140FCA23DB0E48F120ADB(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("BUTTONBCB6700D91DD47AA8312FC3749D2E733")) {
        
        printPageButtonBCB6700D91DD47AA8312FC3749D2E733(response, vars, strProcessId);
...
PInstanceProcessData.insertPInstanceParamDate(this, pinstance, "20", "BeginDate", strbegindate, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        processButtonHelper(request, response, vars, pinstance);        
    } else if (vars.commandIn("SAVE_BUTTONActionButton5FB0B21BF50F4384B58CDBD39D45CA06")) {
        
        String strProcessing = "Y";
        String pinstance = SequenceIdData.getUUID();
        PInstanceProcessData.insertPInstance(this, pinstance, "5FB0B21BF50F4384B58CDBD39D45CA06", "0", strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "60", "outputType", stroutputtype, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        processButtonHelper(request, response, vars, pinstance);        
    } else if (vars.commandIn("SAVE_BUTTONActionButton9124E14C358140FCA23DB0E48F120ADB")) {
        
        String strProcessing = "Y";
        String pinstance = SequenceIdData.getUUID();
        PInstanceProcessData.insertPInstance(this, pinstance, "9124E14C358140FCA23DB0E48F120ADB", "0", strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
        String strmProductId = vars.getStringParameter("inpmProductId");
...
String stradOrgId = vars.getStringParameter("inpadOrgId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "AD_ORG_ID", stradOrgId, vars.getClient(), vars.getOrg(), vars.getUser());
String strisconsumable = vars.getNumericParameter("inpisconsumable");
PInstanceProcessData.insertPInstanceParamNumber(this, pinstance, "20", "ISCONSUMABLE", strisconsumable, vars.getClient(), vars.getOrg(), vars.getUser());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "80", "ISINTERNAL", strisinternal, vars.getClient(), vars.getOrg(), vars.getUser());
String strissparepart = vars.getStringParameter("inpissparepart", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "100", "ISSPAREPART", strissparepart, vars.getClient(), vars.getOrg(), vars.getUser());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "30", "outputType", stroutputtype, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        processButtonHelper(request, response, vars, pinstance);        
    } else if (vars.commandIn("SAVE_BUTTONActionButtonBCB6700D91DD47AA8312FC3749D2E733")) {
        
        String strProcessing = "Y";
        String pinstance = SequenceIdData.getUUID();
        PInstanceProcessData.insertPInstance(this, pinstance, "BCB6700D91DD47AA8312FC3749D2E733", "0", strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
        String strmProductId = vars.getStringParameter("inpmProductId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "5", "M_PRODUCT_ID", strmProductId, vars.getClient(), vars.getOrg(), vars.getUser());
String stradOrgId = vars.getStringParameter("inpadOrgId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "AD_ORG_ID", stradOrgId, vars.getClient(), vars.getOrg(), vars.getUser());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "outputType", stroutputtype, vars.getClient(), vars.getOrg(), vars.getUser());
String stronlyonelevel = vars.getStringParameter("inponlyonelevel", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "30", "ONLYONELEVEL", stronlyonelevel, vars.getClient(), vars.getOrg(), vars.getUser());
String stradLanguage = vars.getStringParameter("inpadLanguage");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "30", "AD_LANGUAGE", stradLanguage, vars.getClient(), vars.getOrg(), vars.getUser());
String strissparepart = vars.getStringParameter("inpissparepart", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "40", "ISSPAREPART", strissparepart, vars.getClient(), vars.getOrg(), vars.getUser());
String strisinternal = vars.getStringParameter("inpisinternal", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "50", "ISINTERNAL", strisinternal, vars.getClient(), vars.getOrg(), vars.getUser());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "outputType", stroutputtype, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  void printPageFrames(HttpServletResponse response, VariablesSecureApp vars, String strProcessId) throws IOException, ServletException {
    ...
    void printPageButton5FB0B21BF50F4384B58CDBD39D45CA06(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
    ...
    void printPageButton9124E14C358140FCA23DB0E48F120ADB(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
    ...
    void printPageButtonBCB6700D91DD47AA8312FC3749D2E733(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
